...
(function(p) { "object" === typeof module && module.exports ? module.exports = p : p(Highcharts) })(function(p) {
    (function(g) {
        var p = g.win.document,
            ...
            x = g.isNumber,
            B = g.splat,
            n, u = function(b, a) { this.init(b, a) };
        g.extend(u.prototype, {
            ...
            getColumnDistribution: function() {
                var b = this.chartOptions,
                    a = this.options,
                    d = [],
                    f = function(b) { return (g.seriesTypes[b || "line"].prototype.pointArrayMap || [0]).length },
                    e = b && b.chart && b.chart.type,
                    c = [],
                    k = [],
                    t = 0,
                    h;
                m(b && b.series || [], function(b) { c.push(f(b.type || e)) });
                m(a && a.seriesMapping || [], function(b) { d.push(b.x || 0) });
                0 === d.length && d.push(0);
                m(a && a.seriesMapping || [], function(a) {
                    ...
                    z(a, function(b, a) { "x" !== a && d.addColumnReader(b, a) });
            ...
            parseTable: function() { var b = this.options,
                    a = b.table,
                    d = this.columns,
                    f = b.startRow || 0,
                ...
                a && ("string" === typeof a && (a = p.getElementById(a)), m(a.getElementsByTagName("tr"), function(b, a) { a >= f && a <= e && m(b.children, function(b, e) {
                        ("TD" === b.tagName || "TH" === b.tagName) && e >= c && e <= k && (d[e - c] || (d[e - c] = []), d[e - c][a - f] = b.innerHTML) }) }), this.dataFound()) },
            parseGoogleSpreadsheet: function() {
                ...
                d && jQuery.ajax({
                    ...
                    success: function(a) {
                        ...
                        m(f, function(a) { for (l = 0; l < a.length; l++) void 0 === a[l] && (a[l] = null) });
                        b.dataFound()
                    }
                })
            },
            trim: function(b, a) { "string" === typeof b && (b = b.replace(/^\s+|\s+$/g, ""), a && /^[0-9\s]+$/.test(b) && (b = b.replace(/\s/g, "")), this.decimalRegex && (b = b.replace(this.decimalRegex, "$1.$2"))); return b },
            parseTypes: function() {
            ...
            dateFormats: {
                ...
                "dd/mm/YYYY": { regex: /^([0-9]{1,2})[\-\/\.]([0-9]{1,2})[\-\/\.]([0-9]{4})$/, parser: function(b) { return Date.UTC(+b[3], b[2] - 1, +b[1]) }, alternative: "mm/dd/YYYY" },
                "mm/dd/YYYY": { regex: /^([0-9]{1,2})[\-\/\.]([0-9]{1,2})[\-\/\.]([0-9]{4})$/, parser: function(b) { return Date.UTC(+b[3], b[1] - 1, +b[2]) } },
                "dd/mm/YY": { regex: /^([0-9]{1,2})[\-\/\.]([0-9]{1,2})[\-\/\.]([0-9]{2})$/, parser: function(b) { return Date.UTC(+b[3] + 2E3, b[2] - 1, +b[1]) }, alternative: "mm/dd/YY" },
                ...
                if (a) d = a(b);
                    ...
                    if (e) a = this.dateFormats[e], (c = b.match(a.regex)) && (d = a.parser(c));
                        ...
                        for (f in this.dateFormats)
                            if (a = this.dateFormats[f], c = b.match(a.regex)) { this.dateFormat = f;
            ...
            rowsToColumns: function(b) { var a, d, f, e, c; if (b)
                    for (c = [], d = b.length, a = 0; a < d; a++)
                        for (e = b[a].length, f = 0; f < e; f++) c[f] || (c[f] = []), c[f][a] = b[a][f]; return c },
        ...
        g.Data = u;
        g.data = function(b, a) { return new u(b, a) };
        ...
        n = function() { this.readers = [];
            this.pointIsArray = !0 };
        n.prototype.populateColumns = function(b) { var a = !0;
            m(this.readers, function(a) { void 0 === a.columnIndex && (a.columnIndex = b.shift()) });
            m(this.readers, function(b) { void 0 === b.columnIndex && (a = !1) }); return a };
        ...
        n.prototype.addColumnReader = function(b, a) { this.readers.push({ columnIndex: b, configName: a }); "x" !== a && "y" !== a && void 0 !== a && (this.pointIsArray = !1) };
        n.prototype.getReferencedColumnIndexes = function() { var b, a = [],
                d; for (b = 0; b < this.readers.length; b += 1) d = this.readers[b], void 0 !== d.columnIndex && a.push(d.columnIndex); return a };
        n.prototype.hasReader = function(b) { var a, d; for (a = 0; a < this.readers.length; a += 1)
...
/*
 ...
 License: www.highcharts.com/license
*/
(function(L, S) { "object" === typeof module && module.exports ? module.exports = L.document ? S(L) : S : L.Highcharts = S(L) })("undefined" !== typeof window ? window : this, function(L) {
    L = function() {
        var a = window,
            D = a.document,
    ...
    (function(a) {
        ...
        a.Fx = function(a, f, h) { this.options = f;
            this.elem = a;
            this.prop = h };
        a.Fx.prototype = {
            dSetter: function() { var a = this.paths[0],
                    f = this.paths[1],
                    h = [],
                    l = this.now,
                    w = a.length,
            ...
            run: function(a, f, h) { var n = this,
                    w = function(a) { return w.stopped ? !1 : n.step(a) },
                    t;
                ...
                w.elem = this.elem;
                w.prop = this.prop;
                w() && 1 === D.push(w) && (w.timerId = setInterval(function() { for (t = 0; t < D.length; t++) D[t]() || D.splice(t--, 1);
                    D.length || clearInterval(w.timerId) }, 13)) },
            step: function(n) {
                var f = +new Date,
                    h, l = this.options,
                    w = this.elem,
                    ...
                    e = l.duration,
                    d = l.curAnim;
                w.attr && !w.element ? n = !1 : n || f >= e + this.startTime ? (this.now = this.end, this.pos = 1, this.update(), h = d[this.prop] = !0, a.objectEach(d, function(a) {!0 !== a && (h = !1) }), h && t && t.call(w), n = !1) : (this.pos = l.easing((f - this.startTime) / e), this.now = this.start + (this.end - this.start) * this.pos, this.update(), n = !0);
                return n
            },
            initPath: function(n, f, h) {
                function l(a) { var b, c; for (u = a.length; u--;) b = "M" === a[u] || "L" === a[u], c = /[a-zA-Z]/.test(a[u + 3]), b && c && a.splice(u + 1, 0, a[u + 1], a[u + 2], a[u + 1], a[u + 2]) }

                function w(a, c) { for (; a.length < x;) { a[0] = c[x - a.length]; var k = a.slice(0, b);
                        [].splice.apply(a, [0, 0].concat(k));
                        B && (k = a.slice(a.length - b), [].splice.apply(a, [a.length, 0].concat(k)), u--) }
                    a[0] = "M" }

                function t(a, k) { for (var p = (x - a.length) / b; 0 < p && p--;) c = a.slice().splice(a.length / I - b, b * I), c[0] = k[x - b - p * b], C && (c[b - 6] = c[b - 2], c[b - 5] = c[b - 1]), [].splice.apply(a, [a.length / I, 0].concat(c)), B && p-- }
                f = f || "";
                var e, d = n.startX,
                    m = n.endX,
                    C = -1 < f.indexOf("C"),
                ...
                C && (l(f),
                    l(h));
                if (d && m) { for (u = 0; u < d.length; u++)
                        if (d[u] === m[0]) { e = u; break } else if (d[0] === m[m.length - d.length + u]) { e = u;
                        k = !0; break }
                    void 0 === e && (f = []) }
        ...
        a.extend = function(a, f) { var n;
            a || (a = {}); for (n in f) a[n] = f[n]; return a };
        a.merge = function() {
            var n, f = arguments,
                h, l = {},
                w = function(f, e) { "object" !== typeof f && (f = {});
                    a.objectEach(e, function(d, m) {!a.isObject(d, !0) || a.isClass(d) || a.isDOMElement(d) ? f[m] = e[m] : f[m] = w(f[m] || {}, d) }); return f };
        ...
        a.isObject = function(n, f) { return !!n && "object" === typeof n && (!f || !a.isArray(n)) };
        ...
        a.erase = function(a, f) { for (var n = a.length; n--;)
                if (a[n] === f) { a.splice(n, 1); break } };
        a.defined = function(a) { return void 0 !== a && null !== a };
        a.attr = function(n, f, h) { var l;
            a.isString(f) ? a.defined(h) ? n.setAttribute(f, h) : n && n.getAttribute && (l = n.getAttribute(f)) : a.defined(f) && a.isObject(f) && a.objectEach(f, function(a, f) { n.setAttribute(f, a) }); return l };
        a.splat =
            function(n) { return a.isArray(n) ? n : [n] };
        a.syncTimeout = function(a, f, h) { if (f) return setTimeout(a, f, h);
            a.call(0, h) };
        a.pick = function() { var a = arguments,
                f, h, l = a.length; for (f = 0; f < l; f++)
                if (h = a[f], void 0 !== h && null !== h) return h };
        a.css = function(n, f) { a.isMS && !a.svg && f && void 0 !== f.opacity && (f.filter = "alpha(opacity\x3d" + 100 * f.opacity + ")");
            a.extend(n.style, f) };
        a.createElement = function(n, f, h, l, w) {
            n = G.createElement(n);
            var t = a.css;
            f && a.extend(n, f);
            w && t(n, { padding: 0, border: "none", margin: 0 });
            h && t(n, h);
            l && l.appendChild(n);
            return n
        };
        a.extendClass = function(n, f) { var h = function() {};
            h.prototype = new n;
            a.extend(h.prototype, f); return h };
        a.pad = function(a, f, h) { return Array((f || 2) + 1 - String(a).length).join(h || 0) + a };
        a.relativeLength = function(a, f) { return /%$/.test(a) ? f * parseFloat(a) / 100 : parseFloat(a) };
        a.wrap = function(a, f, h) { var l = a[f];
            a[f] = function() { var a = Array.prototype.slice.call(arguments),
                    f = arguments,
                    e = this;
                e.proceed = function() { l.apply(e, arguments.length ? arguments : f) };
                a.unshift(l);
                a = h.apply(this, a);
                e.proceed = null; return a } };
        a.getTZOffset = function(n) { var f = a.Date; return 6E4 * (f.hcGetTimezoneOffset && f.hcGetTimezoneOffset(n) || f.hcTimezoneOffset || 0) };
        a.dateFormat = function(n, f, h) {
            ...
            a.objectEach(l, function(a, b) { for (; - 1 !== n.indexOf("%" + b);) n = n.replace("%" + b, "function" === typeof a ? a(f) : a) });
        ...
        a.format = function(n, f) { for (var h = "{", l = !1, w, t, e, d, m = [], C; n;) { h = n.indexOf(h); if (-1 === h) break;
                w = n.slice(0, h); if (l) { w = w.split(":");
                    t = w.shift().split(".");
                    d = t.length;
                    C = f; for (e = 0; e < d; e++) C = C[t[e]];
                    w.length && (C = a.formatSingle(w.join(":"), C));
                    m.push(C) } else m.push(w);
                n = n.slice(h + 1);
                h = (l = !l) ? "}" : "{" }
            m.push(n); return m.join("") };
        a.getMagnitude = function(a) {
            return Math.pow(10,
                Math.floor(Math.log(a) / Math.LN10))
        };
        a.normalizeTickInterval = function(n, f, h, l, w) { var t, e = n;
            h = a.pick(h, 1);
            t = n / h;
            f || (f = w ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10], !1 === l && (1 === h ? f = a.grep(f, function(a) { return 0 === a % 1 }) : .1 >= h && (f = [1 / h]))); for (l = 0; l < f.length && !(e = f[l], w && e * h >= n || !w && t <= (f[l] + (f[l + 1] || f[l])) / 2); l++); return e = a.correctFloat(e * h, -Math.round(Math.log(.001) / Math.LN10)) };
        ...
        a.arrayMin = function(a) { for (var f = a.length, h = a[0]; f--;) a[f] < h && (h = a[f]); return h };
        a.arrayMax = function(a) { for (var f = a.length, h = a[0]; f--;) a[f] > h && (h = a[f]); return h };
        a.destroyObjectProperties = function(n, f) { a.objectEach(n, function(a, l) { a && a !== f && a.destroy && a.destroy();
                delete n[l] }) };
        a.discardElement = function(n) { var f = a.garbageBin;
        ...
        a.setAnimation = function(n, f) { f.renderer.globalAnimation = a.pick(n, f.options.chart.animation, !0) };
        ...
        a.inArray = function(a, f) { return f.indexOf ? f.indexOf(a) : [].indexOf.call(f, a) };
        a.grep = function(a, f) { return [].filter.call(a, f) };
        a.find = function(a, f) { return [].find.call(a, f) };
        a.map = function(a, f) { for (var h = [], l = 0, n = a.length; l < n; l++) h[l] = f.call(a[l], a[l], l, a); return h };
        a.offset = function(a) {
        ...
        a.stop = function(a, f) { for (var h = D.length; h--;) D[h].elem !== a || f && f !== D[h].prop || (D[h].stopped = !0) };
        a.each = function(a, f, h) { return Array.prototype.forEach.call(a, f, h) };
        a.objectEach = function(a, f, h) { for (var l in a) a.hasOwnProperty(l) && f.call(h, a[l], l, a) };
        a.addEvent = function(n, f, h) {
            function l(a) { a.target = a.srcElement || F;
                h.call(n, a) }
            ...
            w[f] || (w[f] = []);
            w[f].push(h);
            return function() { a.removeEvent(n, f, h) }
        };
        a.removeEvent = function(n, f, h) {
            function l(a, d) { n.removeEventListener ? n.removeEventListener(a, d, !1) : n.attachEvent && (d = n.hcEventsIE[d.toString()], n.detachEvent("on" + a, d)) }

            function w() { var d, C;
                n.nodeName && (f ? (d = {}, d[f] = !0) : d = e, a.objectEach(d, function(a, d) { if (e[d])
        ...
        a.fireEvent = function(n, f, h, l) {
            ...
            if (G.createEvent && (n.dispatchEvent || n.fireEvent)) w = G.createEvent("Events"), w.initEvent(f, !0, !0), a.extend(w, h), n.dispatchEvent ? n.dispatchEvent(w) : n.fireEvent(f, w);
                ...
                for (w = w[f] || [], t = w.length, h.target || a.extend(h, { preventDefault: function() { h.defaultPrevented = !0 }, target: n, type: f }), f = 0; f < t; f++)(e = w[f]) && !1 === e.call(n, h) && h.preventDefault();
        ...
        a.animate = function(n, f, h) {
            var l, w = "",
                t, e, d;
            a.isObject(h) || (d = arguments, h = { duration: d[2], easing: d[3], complete: d[4] });
        ...
        a.seriesType = function(n, f, h, l, w) { var t = a.getOptions(),
                e = a.seriesTypes;
            t.plotOptions[n] = a.merge(t.plotOptions[f], h);
            e[n] = a.extendClass(e[f] || function() {}, l);
            e[n].prototype.type = n;
            w && (e[n].prototype.pointClass = a.extendClass(a.Point, w)); return e[n] };
        a.uniqueKey = function() { var a = Math.random().toString(36).substring(2, 9),
                f = 0; return function() { return "highcharts-" + a + "-" + f++ } }();
        ...
        G && !G.defaultView && (a.getStyle = function(n, f) {
            var h = { width: "clientWidth", height: "clientHeight" }[f];
            if (n.style[f]) return a.pInt(n.style[f]);
            "opacity" === f && (f = "filter");
            if (h) return n.style.zoom = 1, Math.max(n[h] - 2 * a.getStyle(n, "padding"), 0);
            n = n.currentStyle[f.replace(/\-(\w)/g, function(a, f) { return f.toUpperCase() })];
        ...
        Array.prototype.forEach || (a.each = function(a, f, h) { for (var l = 0, n = a.length; l < n; l++)
                if (!1 === f.call(h, a[l], l, a)) return l });
        Array.prototype.indexOf || (a.inArray = function(a, f) { var h, l = 0; if (f)
                for (h = f.length; l < h; l++)
                    if (f[l] === a) return l;
            return -1 });
        Array.prototype.filter || (a.grep = function(a, f) { for (var h = [], l = 0, n = a.length; l < n; l++) f(a[l], l) && h.push(a[l]); return h });
        Array.prototype.find || (a.find = function(a, f) { var h, l = a.length; for (h = 0; h < l; h++)
    ...
    (function(a) {
        var D =
            ...
            F = a.merge,
            n = a.pInt;
        a.Color = function(f) { if (!(this instanceof a.Color)) return new a.Color(f);
            this.init(f) };
        a.Color.prototype = {
            parsers: [{ regex: /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/, parse: function(a) { return [n(a[1]), n(a[2]), n(a[3]), parseFloat(a[4], 10)] } }, { regex: /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/, parse: function(a) { return [n(a[1]), n(a[2]), n(a[3]), 1] } }],
            names: { white: "#ffffff", black: "#000000" },
            init: function(f) { var h, l, n, t; if ((this.input = f = this.names[f && f.toLowerCase ? f.toLowerCase() : ""] || f) && f.stops) this.stops = G(f.stops, function(e) { return new a.Color(e[1]) });
            ...
            get: function(a) {
                var f = this.input,
                    l = this.rgba,
                    n;
                this.stops ? (n = F(f), n.stops = [].concat(n.stops), D(this.stops, function(f, e) { n.stops[e] = [n.stops[e][0], f.get(a)] })) : n = l && A(l[0]) ? "rgb" === a || !a && 1 === l[3] ? "rgb(" + l[0] + "," + l[1] + "," + l[2] + ")" : "a" === a ? l[3] : "rgba(" + l.join(",") + ")" : f;
                return n
            },
            brighten: function(a) { var f, l = this.rgba; if (this.stops) D(this.stops, function(f) { f.brighten(a) });
                else if (A(a) && 0 !== a)
                    for (f = 0; 3 > f; f++) l[f] += n(255 * a), 0 > l[f] && (l[f] = 0), 255 < l[f] && (l[f] = 255); return this },
    ...
    (function(a) {
        ...
        D.prototype = {
            ...
            init: function(a, g) { this.element = "span" === g ? w(g) : m.createElementNS(this.SVG_NS, g);
                this.renderer = a },
            animate: function(v, g, b) { g = a.animObject(K(g, this.renderer.globalAnimation, !0));
                0 !== g.duration ? (b && (g.complete = b), F(this, v, g)) : (this.attr(v, null, b), g.step && g.step.call(this)); return this },
            colorGradient: function(v, g, b) {
                ...
                k && (p = v[k], Q = r.gradients, u = v.stops, y = b.radialReference, I(p) && (v[k] =
                    p = { x1: p[0], y1: p[1], x2: p[2], y2: p[3], gradientUnits: "userSpaceOnUse" }), "radialGradient" === k && y && !t(p.gradientUnits) && (d = p, p = q(p, r.getRadialAttr(y, d), { gradientUnits: "userSpaceOnUse" })), H(p, function(a, v) { "id" !== v && E.push(v, a) }), H(u, function(a) { E.push(a) }), E = E.join(","), Q[E] ? y = Q[E].attr("id") : (p.id = y = a.uniqueKey(), Q[E] = e = r.createElement(k).attr(p).add(r.defs), e.radAttr = d, e.stops = [], C(u, function(v) {
                    ...
                    e.stops.push(v)
                })), J = "url(" + r.url + "#" + y + ")", b.setAttribute(g, J), b.gradient = E, v.toString = function() { return J })
            },
            applyTextOutline: function(v) {
                ...
                if ((c = v[0]) && "none" !== c && a.svg) {
                    ...
                    k = g.firstChild;
                    C(v, function(a, v) { 0 === v && (a.setAttribute("x", g.getAttribute("x")), v = g.getAttribute("y"), a.setAttribute("y", v || 0), null === v && g.setAttribute("y", 0));
                        a = a.cloneNode(1);
                        n(a, { "class": "highcharts-text-outline", fill: r, stroke: r, "stroke-width": c, "stroke-linejoin": "round" });
                        g.insertBefore(a, k) })
                }
            },
            attr: function(a, g, b, r) {
                ...
                "string" === typeof a ? q = (this[a + "Getter"] || this._defaultGetter).call(this, a, c) : (H(a, function(v, g) { p = !1;
                        r || R(this, g);
                        this.symbolName && /^(x|y|width|height|r|start|end|innerR|anchorX|anchorY)$/.test(g) && (k || (this.symbolAttr(a), k = !0), p = !0);!this.rotation || "x" !== g && "y" !== g || (this.doTransform = !0);
                        p || (d = this[g + "Setter"] || this._defaultSetter, d.call(this, v, g, c), this.shadows && /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(g) && this.updateShadows(g, v, d)) }, this), this.doTransform &&
                    (this.updateTransform(), this.doTransform = !1));
                b && b();
                return q
            },
            updateShadows: function(a, g, b) { for (var v = this.shadows, r = v.length; r--;) b.call(v[r], "height" === a ? Math.max(g - (v[r].cutHeight || 0), 0) : "d" === a ? this.d : g, a, v[r]) },
            addClass: function(a, g) { var v = this.attr("class") || ""; - 1 === v.indexOf(a) && (g || (a = (v + (v ? " " : "") + a).replace("  ", " ")), this.attr("class", a)); return this },
            hasClass: function(a) { return -1 !== n(this.element, "class").indexOf(a) },
            removeClass: function(a) {
                n(this.element, "class", (n(this.element, "class") ||
                    "").replace(a, ""));
                return this
            },
            symbolAttr: function(a) { var v = this;
                C("x y r start end width height innerR anchorX anchorY".split(" "), function(g) { v[g] = K(a[g], v[g]) });
            ...
            crisp: function(a, g) {
                ...
                H(a, function(a, g) { v[g] !== a && (v[g] = b[g] = a) });
                return b
            },
            css: function(a) {
                var v = this.styles,
                ...
                v && H(a, function(a, g) { a !== v[g] && (r[g] = a, d = !0) });
                d && (v && (a = b(v, r)), k = this.textWidth = a && a.width && "auto" !== a.width && "text" === c.nodeName.toLowerCase() && g(a.width), this.styles = a, k && !J && this.renderer.forExport && delete a.width,
                    E && !J ? l(this.element, a) : (p = function(a, v) { return "-" + v.toLowerCase() }, H(a, function(a, v) {-1 === B(v, e) && (q += v.replace(/([A-Z])/g, p) + ":" + a + ";") }), q && n(c, "style", q)), this.added && ("text" === this.element.nodeName && this.renderer.buildText(this), a && a.textOutline && this.applyTextOutline(a.textOutline)));
                return this
            },
            ...
            on: function(a, g) {
                var v = this,
                    b = v.element;
                u && "click" === a ? (b.ontouchstart = function(a) { v.touchEventFired = Date.now();
                        a.preventDefault();
                        g.call(b, a) },
                    b.onclick = function(a) {
                        (-1 === P.navigator.userAgent.indexOf("Android") || 1100 < Date.now() - (v.touchEventFired || 0)) && g.call(b, a) }) : b["on" + a] = g;
                return this
            },
            setRadialReference: function(a) { var v = this.renderer.gradients[this.element.gradient];
                this.element.radialReference = a;
                v && v.radAttr && v.animate(this.renderer.getRadialAttr(a, v.radAttr)); return this },
            translate: function(a, g) { return this.attr({ translateX: a, translateY: g }) },
            ...
            align: function(a, g, b) {
                ...
                c = r.alignedObjects;
                var p, d;
                if (a) { if (this.alignOptions = a, this.alignByTranslate = g, !b || z(b)) this.alignTo = v = b || "renderer", x(c, this), c.push(this), b = null } else a = this.alignOptions, g = this.alignByTranslate, v = this.alignTo;
                b = K(b, r[v], r);
                v = a.align;
                r = a.verticalAlign;
                c = (b.x || 0) + (a.x || 0);
            ...
            getBBox: function(a, g) {
                ...
                if (!v) {
                        ...
                        try {
                            (u = this.fakeTS && function(a) {
                                C(k.querySelectorAll(".highcharts-text-outline"),
                                    function(v) { v.style.display = a })
                            }) && u("none"), v = k.getBBox ? b({}, k.getBBox()) : { width: k.offsetWidth, height: k.offsetHeight }, u && u("")
                        } catch (W) {}
                    ...
                    if (y && 0 < v.height) { for (; 250 < Q.length;) delete m[Q.shift()];
                        m[y] || Q.push(y);
                        m[y] = v }
                }
                return v
            ...
            safeRemoveChild: function(a) { var v = a.parentNode;
                v && v.removeChild(a) },
            destroy: function() {
                var a = this,
                    g = a.element || {},
                ...
                R(a);
                a.clipPath && r && (C(r.querySelectorAll("[clip-path]"), function(v) {-1 < v.getAttribute("clip-path").indexOf(a.clipPath.element.id + ")") && v.removeAttribute("clip-path") }), a.clipPath = a.clipPath.destroy());
                if (a.stops) {
            ...
            shadow: function(a, g, b) {
                ...
                if (!a) this.destroyShadows();
                    ...
                    for (r = 1; r <= p; r++) c =
                        k.cloneNode(0), q = 2 * p + 1 - 2 * r, n(c, { isShadow: "true", stroke: a.color || "#000000", "stroke-opacity": d * r, "stroke-width": q, transform: "translate" + e, fill: "none" }), b && (n(c, "height", Math.max(n(c, "height") - q, 0)), c.cutHeight = q), g ? g.element.appendChild(c) : k.parentNode.insertBefore(c, k), v.push(c);
                    this.shadows = v
                }
                return this
            },
            destroyShadows: function() { C(this.shadows || [], function(a) { this.safeRemoveChild(a) }, this);
                this.shadows = void 0 },
            xGetter: function(a) {
                "circle" === this.element.nodeName && ("x" === a ? a = "cx" : "y" === a && (a = "cy"));
                return this._defaultGetter(a)
            },
            _defaultGetter: function(a) { a = K(this[a], this.element ? this.element.getAttribute(a) : null, 0); /^[\-0-9\.]+$/.test(a) && (a = parseFloat(a)); return a },
            dSetter: function(a, g, b) { a && a.join && (a = a.join(" ")); /(NaN| {2}|^$)/.test(a) && (a = "M 0 0");
                b.setAttribute(g, a);
                this[g] = a },
            ...
            opacitySetter: function(a, g, b) { this[g] = a;
                b.setAttribute(g, a) },
            ...
            visibilitySetter: function(a, g, b) { "inherit" === a ? b.removeAttribute(g) : b.setAttribute(g, a) },
            zIndexSetter: function(a, b) {
                ...
                if (k) {
                    ...
                    b = c.childNodes; for (d = 0; d < b.length && !p; d++) r = b[d], k = r.zIndex, r !== q && (g(k) > a || !t(a) && t(k) || 0 > a && !t(k) && c !== v.box) && (c.insertBefore(q, r), p = !0);
                    p || c.appendChild(q) }
                return p
            },
        ...
        D.prototype.translateXSetter = D.prototype.translateYSetter = D.prototype.rotationSetter =
            D.prototype.verticalAlignSetter = D.prototype.scaleXSetter = D.prototype.scaleYSetter = function(a, g) { this[g] = a;
                this.doTransform = !0 };
        D.prototype["stroke-widthSetter"] = D.prototype.strokeSetter = function(a, g, b) { this[g] = a;
        ...
        A.prototype = {
            ...
            init: function(a, g, b, r, c, q) {
                var v;
                r = this.createElement("svg").attr({ version: "1.1", "class": "highcharts-root" }).css(this.getStyle(r));
                v = r.element;
                ...
                this.setSize(g, b, !1);
                var p;
                k && a.getBoundingClientRect && (g = function() { l(a, { left: 0, top: 0 });
                    p = a.getBoundingClientRect();
                    l(a, { left: Math.ceil(p.left) - p.left + "px", top: Math.ceil(p.top) - p.top + "px" }) }, g(), this.unSubPixelFix = G(P, "resize", g))
            },
            getStyle: function(a) {
            ...
            createElement: function(a) { var g = new this.Element;
            ...
            getSpanWidth: function(a, g) { var b = a.getBBox(!0).width;!J && this.forExport && (b = this.measureSpanWidth(g.firstChild.data, a.styles)); return b },
            applyEllipsis: function(a, g, b, r) { var v = this.getSpanWidth(a, g),
                    c = v > r,
                    v = b,
                    k, q = 0,
                    p = b.length,
                    d = function(a) { g.removeChild(g.firstChild);
                        a && g.appendChild(m.createTextNode(a)) }; if (c) { for (; q <= p;) k = Math.ceil((q + p) / 2), v = b.substring(0, k) + "\u2026", d(v), v = this.getSpanWidth(a, g), q === p ? q = p + 1 : v > r ? p = k - 1 : q = k;
                    0 === p && d("") } return c },
            buildText: function(a) {
                var b =
                    ...
                    I = function(a) { var v;
                        v = /(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : t || r.style.fontSize || 12; return f ? g(f) : r.fontMetrics(v, a.getAttribute("style") ? a : b).h };
                R = [k, B, h, f, H, t, z].join();
                if (R !== a.textCache) {
                    for (a.textCache =
                        R; M--;) b.removeChild(p[M]);
                    q || H || B || z || -1 !== k.indexOf(" ") ? (d = /<.*class="([^"]+)".*>/, e = /<.*style="([^"]+)".*>/, u = /<.*href="(http[^"]+)".*>/, E && E.appendChild(b), k = q ? k.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e').replace(/<a/g, "\x3cspan").replace(/<\/(b|strong|i|em|a)>/g, "\x3c/span\x3e").split(/<br.*?>/g) : [k], k = c(k, function(a) { return "" !== a }), C(k, function(g, c) {
                        var k, q = 0;
                        ...
                        C(k, function(g) {
                            if ("" !== g || 1 === k.length) {
                                ...
                                u.test(g) && !v && (n(E, "onclick", 'location.href\x3d"' + g.match(u)[1] + '"'), l(E, { cursor: "pointer" }));
                                ...
                                if (" " !== g) {
                                    ...
                                    n(E, p);
                                    b.appendChild(E);
                                    !q && w && (!J && v && l(E, { display: "block" }), n(E, "dy", I(E)));
                                    if (z) {
                                        ...
                                        var C = [],
                                            Q, t = I(E),
                                            R = a.rotation;
                                        for (B && (y = r.applyEllipsis(a, E, g, z)); !B && f && (p.length || C.length);) a.rotation = 0, Q = r.getSpanWidth(a, E), g = Q > z, void 0 === y && (y = g), g && 1 !== p.length ? (E.removeChild(E.firstChild), C.unshift(p.pop())) : (p = C, C = [], p.length && !h && (E = m.createElementNS(N, "tspan"), n(E, { dy: t, x: x }), H && n(E, "style", H), b.appendChild(E)),
            ...
            getContrast: function(a) { a = h(a).rgba; return 510 < a[0] + a[1] + a[2] ? "#000000" : "#FFFFFF" },
            button: function(a, g, r, c, k, p, d, e, u) {
                ...
                var y, x, z, J;
                k = q({ fill: "#f7f7f7", stroke: "#cccccc", "stroke-width": 1, style: { color: "#333333", cursor: "pointer", fontWeight: "normal" } }, k);
                y = k.style;
                delete k.style;
                p = q(k, { fill: "#e6e6e6" }, p);
                x = p.style;
                delete p.style;
                d = q(k, { fill: "#e6ebf5", style: { color: "#000000", fontWeight: "bold" } }, d);
                z = d.style;
                delete d.style;
                e = q(k, { style: { color: "#cccccc" } }, e);
                J = e.style;
                delete e.style;
                G(v.element, E ? "mouseover" : "mouseenter", function() { 3 !== m && v.setState(1) });
                G(v.element, E ? "mouseout" : "mouseleave", function() { 3 !== m && v.setState(m) });
                v.setState = function(a) { 1 !== a && (v.state = m = a);
                ...
                v.attr(k).css(b({ cursor: "default" }, y));
                return v.on("click", function(a) { 3 !== m && c.call(v, a) })
            },
            crispLine: function(a, g) { a[1] === a[4] && (a[1] = a[4] = Math.round(a[1]) - g % 2 / 2);
                a[2] === a[5] && (a[2] = a[5] = Math.round(a[2]) + g % 2 / 2); return a },
            path: function(a) {
                var g = { fill: "none" };
                I(a) ? g.d =
                    a : p(a) && b(g, a);
            ...
            circle: function(a, g, b) { a = p(a) ? a : { x: a, y: g, r: b };
                g = this.createElement("circle");
                g.xSetter = g.ySetter = function(a, g, b) { b.setAttribute("c" + g, a) }; return g.attr(a) },
            arc: function(a, g, b, r, c, k) { p(a) ? (r = a, g = r.y, b = r.r, a = r.x) : r = { innerR: r, start: c, end: k };
                a = this.symbol("arc", a, g, b, b, r);
                a.r = b; return a },
            rect: function(a, g, b, r, c, k) {
                c = p(a) ? a.r : c;
                var v = this.createElement("rect");
                a = p(a) ? a : void 0 === a ? {} : { x: a, y: g, width: Math.max(b, 0), height: Math.max(r, 0) };
                void 0 !== k &&
                    (a.strokeWidth = k, a = v.crisp(a));
                a.fill = "none";
                c && (a.r = c);
                v.rSetter = function(a, g, b) { n(b, { rx: a, ry: a }) };
                return v.attr(a)
            },
            setSize: function(a, g, b) { var r = this.alignedObjects,
                    c = r.length;
                this.width = a;
                this.height = g; for (this.boxWrapper.animate({ width: a, height: g }, { step: function() { this.attr({ viewBox: "0 0 " + this.attr("width") + " " + this.attr("height") }) }, duration: K(b, !0) ? void 0 : 0 }); c--;) r[c].align() },
            g: function(a) { var g = this.createElement("g"); return a ? g.attr({ "class": "highcharts-" + a }) : g },
            image: function(a, g, r, c,
                k) { var v = { preserveAspectRatio: "none" };
                1 < arguments.length && b(v, { x: g, y: r, width: c, height: k });
                v = this.createElement("image").attr(v);
                v.element.setAttributeNS ? v.element.setAttributeNS("http://www.w3.org/1999/xlink", "href", a) : v.element.setAttribute("hc-svg-href", a); return v },
            symbol: function(a, g, r, c, k, p) {
                ...
                u ? (q = this.path(y), q.attr("fill", "none"),
                    b(q, { symbolName: E, x: g, y: r, width: c, height: k }), p && b(q, p)) : e && (x = a.match(d)[1], q = this.image(x), q.imgwidth = K(O[x] && O[x].width, p && p.width), q.imgheight = K(O[x] && O[x].height, p && p.height), z = function() { q.attr({ width: q.width, height: q.height }) }, C(["width", "height"], function(a) { q[a + "Setter"] = function(a, g) { var b = {},
                            r = this["img" + g],
                            c = "width" === g ? "translateX" : "translateY";
                        this[g] = a;
                        t(r) && (this.element && this.element.setAttribute(g, r), this.alignByTranslate || (b[c] = ((this[g] || 0) - r) / 2, this.attr(b))) } }), t(g) && q.attr({
                    x: g,
                    y: r
                }), q.isImg = !0, t(q.imgwidth) && t(q.imgheight) ? z() : (q.attr({ width: 0, height: 0 }), w("img", { onload: function() { var a = f[v.chartIndex];
                        0 === this.width && (l(this, { position: "absolute", top: "-999em" }), m.body.appendChild(this));
                        O[x] = { width: this.width, height: this.height };
                        q.imgwidth = this.width;
                        q.imgheight = this.height;
                        q.element && z();
                        this.parentNode && this.parentNode.removeChild(this);
                        v.imgCount--; if (!v.imgCount && a && a.onload) a.onload() }, src: x }), this.imgCount++));
                return q
            },
            symbols: {
                circle: function(a, g, b, r) {
                    return this.arc(a +
                        b / 2, g + r / 2, b / 2, r / 2, { start: 0, end: 2 * Math.PI, open: !1 })
                },
                square: function(a, g, b, r) { return ["M", a, g, "L", a + b, g, a + b, g + r, a, g + r, "Z"] },
                triangle: function(a, g, b, r) { return ["M", a + b / 2, g, "L", a + b, g + r, a, g + r, "Z"] },
                "triangle-down": function(a, g, b, r) { return ["M", a, g, "L", a + b, g, a + b / 2, g + r, "Z"] },
                diamond: function(a, g, b, r) { return ["M", a + b / 2, g, "L", a + b, g + r / 2, a + b / 2, g + r, a, g + r / 2, "Z"] },
            ...
            clipRect: function(g, b, r, c) { var k = a.uniqueKey(),
                    q = this.createElement("clipPath").attr({ id: k }).add(this.defs);
            ...
            text: function(a, g, b, r) {
                ...
                r || (a.xSetter = function(a, g, b) { var r = b.getElementsByTagName("tspan"),
                        c, k = b.getAttribute(g),
                        q; for (q = 0; q < r.length; q++) c = r[q], c.getAttribute(g) === k && c.setAttribute(g, a);
                    b.setAttribute(g, a) });
                return a
            },
            ...
            rotCorr: function(a, g, b) { var r = a;
                g && b && (r = Math.max(r * Math.cos(g * e), 4)); return { x: -a / 3 * Math.sin(g * e), y: r } },
            label: function(g, c, k, p, d, e, E, u, m) {
                var v = this,
                    y = v.g("button" !== m && "label"),
                    x = y.text = v.text("", 0, 0, E).attr({ zIndex: 1 }),
                    z, J, f = 0,
                    H = 3,
                    l = 0,
                    B, h, n, R, w, M = {},
                ...
                T = function() { var a = x.element.style,
                        g = {};
                ...
                O = function() {
                    ...
                    g = u ? 0 : N;
                    t(B) && J && ("center" ===
                        w || "right" === w) && (a += { center: .5, right: 1 }[w] * (B - J.width));
                    if (a !== x.x || g !== x.y) x.attr("x", a), void 0 !== g && x.attr("y", g);
                    x.x = a;
                    x.y = g
                };
                P = function(a, g) { z ? z.attr(a, g) : M[a] = g };
                y.onAdd = function() { x.add(y);
                    y.attr({ text: g || 0 === g ? g : "", x: c, y: k });
                    z && t(d) && y.attr({ anchorX: d, anchorY: e }) };
                y.widthSetter = function(g) { B = a.isNumber(g) ? g : null };
                y.heightSetter = function(a) { h = a };
                y["text-alignSetter"] = function(a) { w = a };
                y.paddingSetter = function(a) { t(a) && a !== H && (H = y.padding = a, O()) };
                y.paddingLeftSetter = function(a) {
                    t(a) && a !== l &&
                        (l = a, O())
                };
                y.alignSetter = function(a) { a = { left: 0, center: .5, right: 1 }[a];
                    a !== f && (f = a, J && y.attr({ x: n })) };
                y.textSetter = function(a) { void 0 !== a && x.textSetter(a);
                    T();
                    O() };
                y["stroke-widthSetter"] = function(a, g) { a && (Q = !0);
                    I = this["stroke-width"] = a;
                    P(g, a) };
                y.strokeSetter = y.fillSetter = y.rSetter = function(a, g) { "fill" === g && a && (Q = !0);
                    P(g, a) };
                y.anchorXSetter = function(a, g) { d = y.anchorX = a;
                    P(g, Math.round(a) - U() - n) };
                y.anchorYSetter = function(a, g) { e = y.anchorY = a;
                    P(g, a - R) };
                ...
                y.ySetter = function(a) { R = y.y = Math.round(a);
                    y.attr("translateY", R) };
                var V = y.css;
                return b(y, {
                    css: function(a) { if (a) { var g = {};
                            a = q(a);
                            C(y.textProps, function(b) { void 0 !== a[b] && (g[b] = a[b], delete a[b]) });
                            x.css(g) } return V.call(y, a) },
                    getBBox: function() { return { width: J.width + 2 * H, height: J.height + 2 * H, x: J.x - H, y: J.y - H } },
                    shadow: function(a) { a && (T(), z && z.shadow(a)); return y },
                    destroy: function() {
    ...
    (function(a) {
        ...
        f(a.SVGElement.prototype, {
            ...
            htmlGetBBox: function() { var a = this.element; "text" === a.nodeName && (a.style.position = "absolute"); return { x: a.offsetLeft, y: a.offsetTop, width: a.offsetWidth, height: a.offsetHeight } },
            htmlUpdateTransform: function() {
                if (this.added) {
                    var a = this.renderer,
                        ...
                        k = { left: 0, center: .5, right: 1 }[f],
                        E = this.styles;
                    G(b, { marginLeft: d, marginTop: c });
                    ...
                    this.inverted && n(b.childNodes, function(c) { a.invertChild(c, b) });
                    if ("SPAN" === b.tagName) {
                        var p = this.rotation,
                            z = t(this.textWidth),
                            l = E && E.whiteSpace,
                            q = [p, f, b.innerHTML, this.textWidth, this.textAlign].join();
                        q !== this.cTT && (E = a.fontMetrics(b.style.fontSize).b, F(p) && this.setSpanRotation(p, k, E), G(b, { width: "", whiteSpace: l || "nowrap" }), b.offsetWidth > z && /[ \-]/.test(b.textContent || b.innerText) && G(b, { width: z + "px", display: "block", whiteSpace: l || "normal" }), this.getSpanCorrection(b.offsetWidth, E, k, p, f));
                        G(b, {
                            left: e +
                                (this.xCorr || 0) + "px",
            ...
            setSpanRotation: function(a, b, e) { var c = {},
                ...
                G(this.element, c) },
            getSpanCorrection: function(a, b, d) { this.xCorr = -a * d;
                this.yCorr = -b }
        });
        f(e.prototype, {
            html: function(a, b, d) {
                var c = this.createElement("span"),
                    ...
                    x = c.renderer,
                    l = x.isSVG,
                    k = function(a, b) { n(["opacity", "visibility"], function(c) { m(a, c + "Setter", function(a, c, k, p) { a.call(this, c, k, p);
                                b[k] = c }) }) };
                c.textSetter = function(a) { a !== e.innerHTML && delete this.bBox;
                    e.innerHTML = this.textStr = a;
                    c.htmlUpdateTransform() };
                l && k(c, c.element.style);
                c.xSetter = c.ySetter = c.alignSetter = c.rotationSetter = function(a, b) { "align" === b && (b = "textAlign");
                    c[b] = a;
                    c.htmlUpdateTransform() };
                c.attr({ text: a, x: Math.round(b), y: Math.round(d) }).css({
                    ...
                    if (this.parentGroup = a) {
                        if (b = a.div, !b) {
                            ...
                            n(m.reverse(), function(a) {
                                ...
                                q && (q = { className: q });
                                b = a.div = a.div || A("div", q, { position: "absolute", left: (a.translateX || 0) + "px", top: (a.translateY || 0) + "px", display: a.display, opacity: a.opacity, pointerEvents: a.styles && a.styles.pointerEvents }, b || d);
                                p = b.style;
                                f(a, {
                                    on: function() {
                                        c.on.apply({ element: m[0].div },
                                            arguments);
                                        return a
                                    },
                                    translateXSetter: function(b, g) { p.left = b + "px";
                                        a[g] = b;
                                        a.doTransform = !0 },
                                    translateYSetter: function(b, g) { p.top = b + "px";
                                        a[g] = b;
                                        a.doTransform = !0 }
                                });
                                k(a, p)
    ...
    (function(a) {
        ...
        a.svg || (A = {
            ...
            init: function(a, b) { var c = ["\x3c", b, ' filled\x3d"f" stroked\x3d"f"'],
                    k = ["position: ", "absolute", ";"],
                    d = "div" === b;
            ...
            getSpanCorrection: function(a, b, c, d, e) { var k = d ? Math.cos(d * f) : 1,
                    p = d ? Math.sin(d * f) : 0,
                ...
                e && "left" !== e && (this.xCorr -= a * c * (0 > k ? -1 : 1), d && (this.yCorr -= m * c * (0 > p ? -1 : 1)), F(this.element, { textAlign: e })) },
            ...
            clip: function(a) { var b = this,
                    c;
                a ? (c = a.members, t(c, b), c.push(b), b.destroyClip = function() { t(c, b) }, a = a.getCSS(b)) : (b.destroyClip && b.destroyClip(), a = { clip: b.docMode8 ? "inherit" : "rect(auto)" }); return b.css(a) },
            css: u.prototype.htmlCss,
            safeRemoveChild: function(a) { a.parentNode && h(a) },
            destroy: function() { this.destroyClip && this.destroyClip(); return u.prototype.destroy.apply(this) },
            on: function(a, b) { this.element["on" + a] = function() { var a = I.event;
                    a.target = a.srcElement;
                    b(a) }; return this },
            cutOffPath: function(a, b) { var k;
                a = a.split(/[ ,]/);
                k = a.length; if (9 === k || 11 === k) a[k - 4] = a[k - 2] = c(a[k - 2]) - 10 * b; return a.join(" ") },
            shadow: function(a, b, d) {
                ...
                if (a) {
                    ...
                    ], m = G(e.prepVML(g), null, { left: c(u.left) + x(a.offsetX, 1), top: c(u.top) + x(a.offsetY, 1) }), d && (m.cutOff = f + 1), g = ['\x3cstroke color\x3d"', a.color || "#000000", '" opacity\x3d"', l * p, '"/\x3e'], G(e.prepVML(g), null, null, m), b ? b.element.appendChild(m) : q.parentNode.insertBefore(m, q), k.push(m);
                    this.shadows = k
                }
                return this
            },
            ...
            dashstyleSetter: function(a, b, c) {
                ...
                this[b] = a },
            dSetter: function(a, b, c) { var k = this.shadows;
                a = a || [];
                this.d = a.join && a.join(" ");
                c.path = a = this.pathToVML(a); if (k)
            ...
            visibilitySetter: function(a, b, c) { "inherit" === a && (a = "visible");
                this.shadows && w(this.shadows, function(c) { c.style[b] = a }); "DIV" === c.nodeName && (a = "hidden" === a ? "-999em" : 0, this.docMode8 || (c.style[b] = a ? "visible" : "hidden"), b = "top");
                c.style[b] = a },
            ...
            init: function(a, b, c) {
                var k, d;
                this.alignedObjects = [];
                k = this.createElement("div").css({ position: "relative" });
                d = k.element;
                ...
                this.setSize(b,
                    c, !1);
                if (!l.namespaces.hcv) { l.namespaces.add("hcv", "urn:schemas-microsoft-com:vml"); try { l.createStyleSheet().cssText = "hcv\\:fill, hcv\\:path, hcv\\:shape, hcv\\:stroke{ behavior:url(#default#VML); display: inline-block; } " } catch (q) { l.styleSheets[0].cssText += "hcv\\:fill, hcv\\:path, hcv\\:shape, hcv\\:stroke{ behavior:url(#default#VML); display: inline-block; } " } }
            },
            ...
            clipRect: function(a, b, c, d) {
                ...
                return e(k, {
                    ...
                    getCSS: function(a) { var b = a.element,
                            c = b.nodeName,
                            g = a.inverted,
                            ...
                            b = q + this.width,
                            k = r + this.height,
                            r = { clip: "rect(" + Math.round(g ? q : r) + "px," + Math.round(g ? k : b) + "px," + Math.round(g ? b : k) + "px," + Math.round(g ? r : q) + "px)" };!g && a.docMode8 && "DIV" === c && e(r, { width: b + "px", height: k + "px" }); return r },
                    updateClipping: function() { w(k.members, function(a) { a.element && a.css(k.getCSS(a)) }) }
                })
            },
            color: function(b,
                c, d, e) {
                ...
                if (u) {
                    ...
                    b = b.stops;
                    var C, h = [],
                        t = function() { m = ['\x3cfill colors\x3d"' + h.join(",") + '" opacity\x3d"', l, '" o:opacity2\x3d"', z, '" type\x3d"', u, '" ', E, 'focus\x3d"100%" method\x3d"any" /\x3e'];
            ...
            path: function(a) { var b = { coordsize: "10 10" };
                d(a) ? b.d = a : C(a) && e(b, a); return this.createElement("shape").attr(b) },
            circle: function(a, b, c) { var d = this.symbol("circle");
                C(a) && (c = a.r, b = a.y, a = a.x);
                d.isCircle = !0;
                d.r = c; return d.attr({ x: a, y: b }) },
            g: function(a) { var b;
                a && (b = { className: "highcharts-" + a, "class": "highcharts-" + a }); return this.createElement("div").attr(b) },
            image: function(a, b, c, d, e) { var q = this.createElement("img").attr({ src: a });
                1 < arguments.length && q.attr({ x: b, y: c, width: d, height: e }); return q },
            createElement: function(a) { return "rect" === a ? this.symbol(a) : B.prototype.createElement.call(this, a) },
            invertChild: function(a, b) { var d = this;
                b = b.style; var k = "IMG" === a.tagName && a.style;
                F(a, { flip: "x", left: c(b.width) - (k ? c(k.top) : 1), top: c(b.height) - (k ? c(k.left) : 1), rotation: -90 });
                w(a.childNodes, function(b) { d.invertChild(b, a) }) },
            symbols: {
                ...
                circle: function(a, b, c, d, e) { e && n(e.r) && (c = d = 2 * e.r);
        ...
        }, a.VMLRenderer = D = function() { this.init.apply(this, arguments) }, D.prototype = b(B.prototype, A), a.Renderer = D);
        B.prototype.measureSpanWidth = function(a, b) { var c = l.createElement("span");
    ...
    (function(a) {
        function D() { var f = a.defaultOptions.global,
                h = l.moment; if (f.timezone) { if (h) return function(a) { return -h.tz(a, f.timezone).utcOffset() };
                a.error(25) } return f.useUTC && f.getTimezoneOffset }
        ...
        function A() {
            ...
            t.hcMakeTime = function(a, b, d, c, m, f) { var u;
                e ? (u = t.UTC.apply(0, arguments), u += n(u)) : u = (new t(a, b, h(d, 1), h(c, 0), h(m, 0), h(f, 0))).getTime(); return u };
            F("Minutes Hours Day Date Month FullYear".split(" "), function(a) { t["hcGet" + a] = d + a });
            F("Milliseconds Seconds Minutes Hours Date Month FullYear".split(" "), function(a) { t["hcSet" + a] = m + a })
        }
        var G = a.color,
            F = a.each,
            n = a.getTZOffset,
        ...
        a.defaultOptions = {
            ...
            global: { useUTC: !0, VMLRadialGradientURL: "http://code.highcharts.com/5.0.11/gfx/vml-radial-gradient.png" },
            chart: { borderRadius: 0, defaultSeriesType: "line", ignoreHiddenSeries: !0, spacing: [10, 10, 15, 10], resetZoomButton: { theme: { zIndex: 20 }, position: { align: "right", x: -10, y: 10 } }, width: null, height: null, borderColor: "#335cad", backgroundColor: "#ffffff", plotBorderColor: "#cccccc" },
            title: {
                text: "Chart title",
                align: "center",
                margin: 15,
        ...
        a.setOptions = function(l) { a.defaultOptions = f(!0, a.defaultOptions, l);
            A(); return a.defaultOptions };
    ...
    (function(a) {
        ...
        a.Tick.prototype = {
            addLabel: function() {
                ...
                this.isFirst = x;
                this.isLast = c;
                h = a.labelFormatter.call({ axis: a, chart: t, isFirst: x, isLast: c, dateTimeLabelFormat: u, value: a.isLog ? D(a.lin2log(d)) : d });
                A(e) ? e &&
                    e.attr({ text: h }) : (this.labelLength = (this.label = e = A(h) && C.enabled ? t.renderer.text(h, 0, 0, C.useHTML).css(n(C.style)).add(a.labelGroup) : null) && e.getBBox().width, this.rotation = 0)
            },
            ...
            handleOverflow: function(a) {
                var l = this.axis,
                    ...
                    C = this.label,
                    b = this.rotation,
                    x = { left: 0, center: .5, right: 1 }[l.labelAlign],
                    c = C.getBBox().width,
                    u = l.getSlotWidth(),
                    B = u,
                    n = 1,
            ...
            getPosition: function(a, f, h, e) {
                ...
                return { x: a ? d.translate(f + h, null, null, e) + d.transB : d.left + d.offset + (d.opposite ? (e && m.oldChartWidth || m.chartWidth) - d.right - d.left : 0), y: a ? l - d.bottom + d.offset - (d.opposite ? d.height : 0) : l - d.translate(f + h, null, null, e) - d.transB }
            },
            ...
            getMarkPath: function(a, f, h, e, d, m) { return m.crispLine(["M", a, f, "L", a + (d ? 0 : -h), f + (d ? h : 0)], e) },
            renderGridLine: function(a, f, h) {
                ...
                if (!a && m && (a = e.getPlotLinePath(b + c, m.strokeWidth() * h, a, !0))) m[this.isNew ? "attr" : "animate"]({ d: a, opacity: f })
            },
            renderMark: function(a, h, n) {
                ...
                x && (e.opposite && (x[0] = -x[0]), u &&
                    (this.mark = c = m.path().addClass("highcharts-" + (l ? l + "-" : "") + "tick").add(e.axisGroup), c.attr({ stroke: d, "stroke-width": t })), c[u ? "attr" : "animate"]({ d: this.getMarkPath(B, a, x[0], c.strokeWidth() * n, e.horiz, m), opacity: h }))
            },
            ...
            render: function(a, h, n) { var e = this.axis,
                    d = e.horiz,
    ...
    var S = function(a) {
        var D =
            ...
            y = a.syncTimeout,
            H = a.Tick,
            K = function() { this.init.apply(this, arguments) };
        a.extend(K.prototype, {
            ...
            getSeriesExtremes: function() {
                ...
                e(a.series, function(g) {
                    if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                        ...
                        if (a.isXAxis) c = g.xData, c.length && (g = F(c), B(g) || g instanceof Date || (c = x(c, function(a) { return B(a) }), g = F(c)), a.dataMin = Math.min(z(a.dataMin, c[0]), g), a.dataMax = Math.max(z(a.dataMax, c[0]), G(c)));
            ...
            translate: function(a, b, c, d, q,
                k) { var g = this.linkedParent || this,
                    r = 1,
                    e = 0,
                    p = d ? g.oldTransA : g.transA;
                d = d ? g.oldMin : g.min; var m = g.minPixelPadding;
                q = (g.isOrdinal || g.isBroken || g.isLog && q) && g.lin2val;
                p || (p = g.transA);
                c && (r *= -1, e = g.len);
                g.reversed && (r *= -1, e -= r * (g.sector || g.len));
                b ? (a = (a * r + e - m) / p + d, q && (a = g.lin2val(a))) : (q && (a = g.val2lin(a)), a = r * (a - d) * p + e + r * m + (B(k) ? p * k : 0)); return a },
            ...
            getPlotLinePath: function(a, b, c, d, q) {
                var g = this.chart,
                    ...
                    y;
                e = this.transB;
                var x = function(a, b, g) { if (a < b || a > g) d ? a = Math.min(Math.max(b, a), g) : y = !0; return a };
            ...
            getLinearTickPositions: function(a, b, c) { var g, r = f(Math.floor(b / a) * a);
                c = f(Math.ceil(c / a) * a); var d = []; if (this.single) return [b]; for (b = r; b <= c;) { d.push(b);
                    b = f(b + a); if (b === g) break;
                    g = b } return d },
            getMinorTickPositions: function() {
                var a = this,
                    ...
                    v = k - p;
                if (v && v / d < a.len / 3)
                    if (a.isLog) e(this.paddedTicks, function(b, g, c) { g && q.push.apply(q, a.getLogTickPositions(d, c[g - 1], c[g], !0)) });
            ...
            nameToX: function(a) { var b = u(this.categories),
                ...
                void 0 !== q && (this.names[q] = a.name); return q },
            ...
            trimTicks: function(a, b, c) { var g = a[0],
                    d = a[a.length - 1],
                    q = this.minPointOffset || 0; if (!this.isLinked) { if (b && -Infinity !== g) this.min = g;
                    else
                        for (; this.min - q > a[0];) a.shift(); if (c) this.max = d;
                    else
            ...
            getTickAmount: function() { var a = this.options,
                    b = a.tickAmount,
                    c = a.tickPixelInterval;!l(a.tickInterval) && this.len < c && !this.isRadial && !this.isLog && a.startOnTick && a.endOnTick && (b = 2);!b && this.alignToOthers() && (b = Math.ceil(this.len / c) + 1);
            ...
            adjustTickAmount: function() {
                var a = this.tickInterval,
                    ...
                    d = this.finalTickAmt,
                    q = b && b.length;
                if (q < c) { for (; b.length < c;) b.push(f(b[b.length - 1] + a));
                    this.transA *= (q - 1) / (c - 1);
                    this.max = b[b.length - 1] } else q > c && (this.tickInterval *= 2, this.setTickPositions());
                if (l(d)) { for (a = c = b.length; a--;)(3 === d && 1 === a % 2 || 2 >= d && 0 < a && a < c - 1) && b.splice(a, 1);
            ...
            setExtremes: function(a, b, c, q, k) {
                ...
                c = z(c, !0);
                e(g.series,
                    function(a) { delete a.kdTree });
                k = d(k, { min: a, max: b });
                m(g, "setExtremes", k, function() { g.userMin = a;
                    g.userMax = b;
                    g.eventArgs = k;
                    c && r.redraw(q) })
            },
            zoom: function(a, b) { var c = this.dataMin,
                    g = this.dataMax,
                    d = this.options,
                    q = Math.min(c, z(d.min, c)),
                    d = Math.max(g, z(d.max, g)); if (a !== this.min || b !== this.max) this.allowZoomOutside || (l(c) && (a < q && (a = q), a > d && (a = d)), l(g) && (b < q && (b = q), b > d && (b = d))), this.displayBtn = void 0 !== a || void 0 !== b, this.setExtremes(a, b, !1, void 0, { trigger: "zoom" }); return !0 },
            ...
            getExtremes: function() {
                var a = this.isLog,
                    b = this.lin2log;
                return { min: a ? f(b(this.min)) : this.min, max: a ? f(b(this.max)) : this.max, dataMin: this.dataMin, dataMax: this.dataMax, userMin: this.userMin, userMax: this.userMax }
            },
            getThreshold: function(a) { var b = this.isLog,
                    c = this.lin2log,
                    g = b ? c(this.min) : this.min,
                    b = b ? c(this.max) : this.max;
                null === a ? a = g : g > a ? a = g : b < a && (a = b); return this.translate(a, 0, 1, 0, 1) },
            autoLabelAlign: function(a) { a = (z(a, 0) - 90 * this.side + 720) % 360; return 15 < a && 165 > a ? "right" : 195 < a && 345 > a ? "left" : "center" },
            tickSize: function(a) {
                var b = this.options,
                    c = b[a +
                        "Length"],
            ...
            labelMetrics: function() { return this.chart.renderer.fontMetrics(this.options.labels.style && this.options.labels.style.fontSize, this.ticks[0] && this.ticks[0].label) },
            unsquish: function() {
                ...
                b ? (y = !a.staggerLines && !a.step && (l(p) ? [p] : q < z(a.autoRotationLimit, 80) && a.autoRotation)) && e(y, function(a) { var b; if (a === p || a && -90 <= a && 90 >= a) m = x(Math.abs(v.h / Math.sin(w * a))), b = m + Math.abs(a / 360), b < u && (u = b, k = a, d = m) }) : a.step || (d = x(v.h));
                this.autoRotation = y;
            ...
            renderUnsquish: function() {
                ...
                else if (m && (f = { width: v + "px" }, !x))
                    for (f.textOverflow = "clip", h = c.length; !p && h--;)
                        if (l = c[h], v = d[l].label) v.styles && "ellipsis" === v.styles.textOverflow ? v.css({ textOverflow: "clip" }) : d[l].labelLength > m && v.css({ width: m + "px" }), v.getBBox().height > this.len / c.length - (y.h - y.f) && (v.specCss = { textOverflow: "ellipsis" });
                u.rotation && (f = { width: (H > .5 * a.chartHeight ? .33 * a.chartHeight : a.chartHeight) + "px" }, x || (f.textOverflow = "ellipsis"));
                if (this.labelAlign = q.align || this.autoLabelAlign(this.labelRotation)) u.align =
                    this.labelAlign;
                e(c, function(a) { var b = (a = d[a]) && a.label;
            ...
            hasData: function() { return this.hasVisibleSeries || l(this.min) && l(this.max) && !!this.tickPositions },
            addTitle: function(a) {
                var b = this.chart.renderer,
                    ...
                    q;
                this.axisTitle || ((q = d.textAlign) || (q = (c ? { low: "left", middle: "center", high: "right" } : {
                    low: g ? "right" : "left",
                    middle: "center",
                    high: g ? "left" : "right"
                })[d.align]), this.axisTitle = b.text(d.text, 0, 0, d.useHTML).attr({ zIndex: 7, rotation: d.rotation || 0, align: q }).addClass("highcharts-axis-title").css(d.style).add(this.axisGroup), this.axisTitle.isNew = !0);
            ...
            getOffset: function() {
                ...
                a.axisGroup || (a.gridGroup = c.g("grid").attr({ zIndex: d.gridZIndex || 1 }).addClass("highcharts-" + this.coll.toLowerCase() + "-grid " + (I || "")).add(K), a.axisGroup = c.g("axis").attr({ zIndex: d.zIndex || 2 }).addClass("highcharts-" + this.coll.toLowerCase() + " " + (I || "")).add(K), a.labelGroup = c.g("axis-labels").attr({
                    zIndex: n.zIndex ||
                        7
                }).addClass("highcharts-" + a.coll.toLowerCase() + "-labels " + (I || "")).add(K));
                y || a.isLinked ? (e(q, function(b, c) { a.generateTick(b, c) }), a.renderUnsquish(), !1 === n.reserveSpace || 0 !== v && 2 !== v && { 1: "left", 3: "right" }[v] !== a.labelAlign && "center" !== a.labelAlign || e(q, function(a) { E = Math.max(k[a].getLabelSize(), E) }), a.staggerLines && (E *= a.staggerLines, a.labelOffset = E * (a.opposite ? -1 : 1))) : p(k, function(a, b) { a.destroy();
                    delete k[b] });
            ...
            getTitlePosition: function() {
                var a =
                    ...
                    d = { low: k + (a ? 0 : d), middle: k + d / 2, high: k + (a ? d : 0) }[q.align],
                    b = (a ? c + this.height : b) + (a ? 1 : -1) * (p ? -1 : 1) * this.axisTitleMargin + (2 === this.side ? y : 0);
                return { x: a ? d + m : b + (p ? this.width : 0) + e + m, y: a ? b + u - (p ? this.height : 0) + e : d + u }
            },
            ...
            renderTick: function(a, b) { var c = this.isLinked,
                    g = this.ticks,
                    d = this.chart.hasRendered && B(this.oldMin); if (!c || a >= this.min && a <= this.max) g[a] || (g[a] = new H(this, a)), d && g[a].isNew && g[a].render(b, !0, .1), g[a].render(b) },
            render: function() {
                var b = this,
                    c = b.chart,
                    d = b.options,
                ...
                b.overlap = !1;
                e([x, f, h], function(a) { p(a, function(a) { a.isActive = !1 }) });
                if (b.hasData() || m) b.minorTickInterval && !b.categories && e(b.getMinorTickPositions(), function(a) { b.renderMinorTick(a) }), u.length && (e(u, function(a, c) { b.renderTick(a, c) }), z && (0 === b.min || b.single) && (x[-1] || (x[-1] = new H(b, -1, null, !0)), x[-1].render(-1))), B && e(u, function(g, d) {
                    I = void 0 !== u[d + 1] ? u[d + 1] + z : b.max - z;
                    0 === d % 2 && g < b.max && I <= b.max + (c.polar ?
                        -z : z) && (h[g] || (h[g] = new a.PlotLineOrBand(b)), t = g + z, h[g].options = { from: q ? k(t) : t, to: q ? k(I) : I, color: B }, h[g].render(), h[g].isActive = !0)
                }), b._addedPlotLB || (e((d.plotLines || []).concat(d.plotBands || []), function(a) { b.addPlotBandOrLine(a) }), b._addedPlotLB = !0);
                e([x, f, h], function(a) { var b, g = [],
                        d = C.duration;
                    p(a, function(a, b) { a.isActive || (a.render(b, !1, 0), a.isActive = !1, g.push(b)) });
                    y(function() { for (b = g.length; b--;) a[g[b]] && !a[g[b]].isActive && (a[g[b]].destroy(), delete a[g[b]]) }, a !== h && c.hasRendered && d ? d : 0) });
                n &&
                    (n[n.isPlaced ? "animate" : "attr"]({ d: this.getLinePath(n.strokeWidth()) }), n.isPlaced = !0, n[E ? "show" : "hide"](!0));
                v && E && (v[v.isNew ? "attr" : "animate"](b.getTitlePosition()), v.isNew = !1);
                l && l.enabled && b.renderStackTotals();
                b.isDirty = !1
            },
            redraw: function() { this.visible && (this.render(), e(this.plotLinesAndBands, function(a) { a.render() }));
            ...
            destroy: function(a) {
                var b = this,
                    ...
                    q;
                a || M(b);
                p(g, function(a, b) { t(a);
                    g[b] = null });
                e([b.ticks, b.minorTicks, b.alternateBands], function(a) { t(a) });
                if (d)
                ...
                p(b, function(a, g) {-1 === c(g, b.keepProps) && delete b[g] })
            },
            drawCrosshair: function(a, b) {
                ...
                this.crosshair && !1 !== (l(b) || !g) ? (g ? l(b) && (q = this.isXAxis ? b.plotX : this.len - b.plotY) : q = a && (this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos), l(q) && (c = this.getPlotLinePath(b && (this.isXAxis ? b.x : z(b.stackY, b.y)), null, null, null, q) || null), l(c) ? (b = this.categories && !this.isRadial, k || (this.cross = k = this.chart.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (b ? "category " : "thin ") + d.className).attr({ zIndex: z(d.zIndex, 2) }).add(), k.attr({
                    stroke: d.color ||
                        (b ? n("#ccd6eb").setOpacity(.25).get() : "#cccccc"),
                    "stroke-width": z(d.width, 1)
                }), d.dashStyle && k.attr({ dashstyle: d.dashStyle })), k.show().attr({ d: c }), b && !d.width && k.attr({ "stroke-width": this.transA }), this.cross.e = a) : this.hideCrosshair()) : this.hideCrosshair()
            },
    ...
    (function(a) {
        ...
        D.prototype.getTimeTicks = function(a, l, b, x) {
            ...
            if (n(l)) {
                ...
                c.push(B);
                p <= d.hour && 1E4 > c.length && f(c, function(a) { 0 === a % 18E5 && "000000000" === G("%H%M%S%L", a) && (m[a] = "day") })
            }
            c.info = h(a, { higherRanks: m, totalRange: p * z });
            return c
        };
    ...
    (function(a, D) {
        var A = a.arrayMax,
            ...
            l = a.merge,
            w = a.pick;
        a.PlotLineOrBand = function(a, e) { this.axis = a;
        ...
        a.PlotLineOrBand.prototype = {
            render: function() {
                var f =
                    ...
                    M = w(m.zIndex, 0),
                    q = m.events,
                    p = { "class": "highcharts-plot-" + (B ? "band " : "line ") + (m.className || "") },
                    y = {},
                    H = e.chart.renderer,
                    K = B ? "bands" : "lines",
                    g = e.log2lin;
                e.isLog && (c = g(c), x = g(x), u = g(u));
                n ? (p = { stroke: z, "stroke-width": m.width }, m.dashStyle && (p.dashstyle = m.dashStyle)) : B && (z && (p.fill = z), m.borderWidth && (p.stroke = m.borderColor, p["stroke-width"] = m.borderWidth));
                y.zIndex = M;
                K +=
                    "-" + M;
                ...
                E && p && p.length ? (k.attr({ d: p }), q && a.objectEach(q, function(a, b) { k.on(b, function(a) { q[b].apply(f, [a]) }) })) : k && (p ? (k.show(), k.animate({ d: p })) : (k.hide(), b && (f.label = b = b.destroy())));
            ...
            renderLabel: function(a, e, d, m) {
                ...
                f || (f = { align: a.textAlign || a.align, rotation: a.rotation, "class": "highcharts-plot-" + (d ? "band" : "line") + "-label " + (a.className || "") }, f.zIndex = m, this.label = f = b.text(a.text, 0, 0, a.useHTML).attr(f).add(), f.css(a.style));
                m = [e[1], e[4], d ? e[6] : e[1]];
                e = [e[2], e[5], d ? e[7] : e[2]];
                d = G(m);
                b = G(e);
            ...
            destroy: function() { h(this.axis.plotLinesAndBands, this);
                delete this.axis;
                n(this) }
        };
        a.extend(D.prototype, {
            getPlotBandPath: function(a, e) { var d = this.getPlotLinePath(e, null, null, !0),
                    m = this.getPlotLinePath(a, null, null, !0),
                    f = this.horiz,
                    b = 1;
                a = a < this.min && e < this.min || a > this.max && e > this.max;
                m && d ? (a && (m.flat = m.toString() === d.toString(), b = 0), m.push(f && d[4] === m[4] ? d[4] + b : d[4], f || d[5] !== m[5] ? d[5] : d[5] + b, f && d[1] === m[1] ? d[1] + b : d[1], f || d[2] !== m[2] ? d[2] : d[2] + b)) : m = null; return m },
            ...
            addPlotBandOrLine: function(f, e) { var d = (new a.PlotLineOrBand(this, f)).render(),
                    m = this.userOptions;
                d && (e && (m[e] = m[e] || [], m[e].push(f)), this.plotLinesAndBands.push(d)); return d },
            removePlotBandOrLine: function(a) {
                for (var e = this.plotLinesAndBands, d = this.options, m = this.userOptions, l = e.length; l--;) e[l].id === a && e[l].destroy();
                f([d.plotLines || [], m.plotLines || [], d.plotBands || [], m.plotBands || []], function(b) { for (l = b.length; l--;) b[l].id === a && h(b, b[l]) })
            },
    ...
    (function(a) {
        ...
        a.Tooltip.prototype = {
            ...
            cleanSplit: function(a) { A(this.chart.series, function(d) { var e = d && d.tt;
                    e && (!e.isActive || a ? d.tt = e.destroy() : e.isActive = !1) }) },
            getLabel: function() {
                var a = this.chart.renderer,
                    e = this.options;
                this.label || (this.split ? this.label = a.g("tooltip") : (this.label = a.label("", 0, 0, e.shape || "callout", null, null, e.useHTML, null, "tooltip").attr({ padding: e.padding, r: e.borderRadius }), this.label.attr({ fill: e.backgroundColor, "stroke-width": e.borderWidth }).css(e.style).shadow(e.shadow)),
            ...
            move: function(a, e, f, b) {
                ...
                G(c, { x: u ? (2 * c.x + a) / 3 : a, y: u ? (c.y + e) / 2 : e, anchorX: m ? void 0 : u ? (2 * c.anchorX + f) / 3 : f, anchorY: m ? void 0 : u ? (c.anchorY + b) / 2 : b });
                d.getLabel().attr(c);
                u && (clearTimeout(this.tooltipTimeout), this.tooltipTimeout = setTimeout(function() { d && d.move(a, e, f, b) }, 32))
            },
            hide: function(a) { var d = this;
                clearTimeout(this.hideTimer);
                a = l(a, this.options.hideDelay, 500);
                this.isHidden || (this.hideTimer = t(function() { d.getLabel()[a ? "fadeOut" : "hide"]();
                    d.isHidden = !0 }, a)) },
            getAnchor: function(a, e) {
                ...
                d || (A(a, function(a) { k = a.series.yAxis;
                    n = a.series.xAxis;
                    h += a.plotX + (!m && n ? n.left - u : 0);
                    l += (a.plotLow ? (a.plotLow + a.plotHigh) / 2 : a.plotY) + (!m && k ? k.top - c : 0) }), h /= a.length, l /= a.length, d = [m ? b.plotWidth - l : h, this.shared && !m && 1 < a.length && e ? e.chartY - c : m ? b.plotHeight - h : l]);
            ...
            getPosition: function(a, e, f) {
                var b = this.chart,
                    ...
                    p = function(a, b, q, g, k, e) { var p = q < g - d,
                            m = g + d + q < b,
                            y = g - d - q;
                        g += d; if (n && m) c[a] = g;
                        else if (!n && p) c[a] = y;
                    ...
                    t = function(a) { var b = h;
                        h = k;
                        k = b;
                        m = a },
                    q = function() {!1 !== p.apply(0, h) ? !1 !== z.apply(0, k) || m || (t(!0), q()) : m ? c.x = c.y = 0 : (t(!0), q()) };
                (b.inverted || 1 < this.len) && t();
                q();
                return c
            },
            defaultFormatter: function(a) { var d = this.points || w(this),
                    e;
                e = [a.tooltipFooterHeaderFormatter(d[0])];
                e = e.concat(a.bodyFormatter(d));
                e.push(a.tooltipFooterHeaderFormatter(d[0], !0)); return e },
            refresh: function(a, e) {
                ...
                e = u[0];
                m = u[1];
                !f || c.series && c.series.noSharedTooltip ? f = c.getLabelConfig() : (A(c, function(a) { a.setState("hover");
                    h.push(a.getLabelConfig()) }), f = { x: c[0].category, y: c[0].y }, f.points = h, c = c[0]);
                this.len = h.length;
                f = d.call(f, this);
                k = c.series;
                this.distance = l(k.tooltipOptions.distance, 16);
                !1 === f ? this.hide() : (d = this.getLabel(), this.isHidden && d.attr({ opacity: 1 }).show(), this.split ? this.renderSplit(f, a) : (d.attr({
                    text: f && f.join ?
                        f.join("") : f
                }), d.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + l(c.colorIndex, k.colorIndex)), d.attr({ stroke: b.borderColor || c.color || k.color || "#666666" }), this.updatePosition({ plotX: e, plotY: m, negative: c.negative, ttBelow: c.ttBelow, h: u[2] || 0 })), this.isHidden = !1)
            },
            renderSplit: function(d, e) {
                ...
                A(d.slice(0, e.length + 1), function(a, d) {
                    ...
                    x || (p.tt = x = c.label(null, null, null, "callout").addClass("highcharts-tooltip-box " + y).attr({ padding: h.padding, r: h.borderRadius, fill: h.backgroundColor, stroke: d.color || q.color || "#333333", "stroke-width": h.borderWidth }).add(k));
                    x.isActive = !0;
                    x.attr({ text: a });
                    x.css(h.style);
                    a = x.getBBox();
                    ...
                    a -= m.plotTop;
                    b.push({ target: d.isHeader ? m.plotHeight + n : a, rank: d.isHeader ? 1 : 0, size: p.tt.getBBox().height + 1, point: d, x: q, tt: x })
                });
                this.cleanSplit();
            ...
            updatePosition: function(a) { var d = this.chart,
                    e = this.getLabel(),
            ...
            getDateFormat: function(a, f, h, b) {
                var d = D("%m-%d %H:%M:%S.%L", f),
                    c, u, m = { millisecond: 15, second: 12, minute: 9, hour: 6, day: 3 },
                    l = "millisecond";
                for (u in e) {
                    if (a === e.week && +D("%w", f) === h && "00:00:00.000" === d.substr(6)) { u = "week"; break }
                    if (e[u] > a) { u = l; break }
                    if (m[u] &&
            ...
            getXDateFormat: function(a, e, f) { e = e.dateTimeLabelFormats; var b = f && f.closestPointRange; return (b ? this.getDateFormat(b, a.x, f.options.startOfWeek, e) : e.day) || e.year },
    ...
    (function(a) {
        ...
        a.Pointer.prototype = {
            ...
            zoomOption: function(a) { var b = this.chart,
                    c = b.options.chart,
                    e = c.zoomType || "",
                    b = b.inverted; /touch/.test(a.type) && (e = d(c.pinchType, e));
            ...
            normalize: function(a,
                ...
                void 0 === d.pageX ? (c = Math.max(a.x, a.clientX - b.left), b = a.y) : (c = d.pageX - b.left, b = d.pageY - b.top); return w(a, { chartX: Math.round(c), chartY: Math.round(b) }) },
            getCoordinates: function(a) {
                var b = { xAxis: [], yAxis: [] };
                l(this.chart.axes, function(c) { b[c.isXAxis ? "xAxis" : "yAxis"].push({ axis: c, value: c.toValue(a[c.horiz ? "chartX" : "chartY"]) }) });
                return b
            },
            getKDPoints: function(a, b, e) {
                var c = [],
                    k, f, p;
                l(a, function(a) { k = a.noSharedTooltip && b;
                    f = !b && a.directTouch;
                ...
                c.sort(function(a, c) { var d = a.distX - c.distX,
                        e = a.dist - c.dist,
                        k = (c.series.group && c.series.group.zIndex) - (a.series.group && a.series.group.zIndex); return 0 !== d && b ? d : 0 !== e ? e : 0 !== k ? k : a.series.index > c.series.index ? -1 : 1 });
            ...
            getHoverData: function(b, e, f, m, k, x) {
                var c = b,
                    u = e,
                    h;
                m ? k ? (h = [], l(f, function(a) { var b = a.noSharedTooltip && k,
                            q = !k && a.directTouch;
                        a.visible && !b && !q && d(a.options.enableMouseTracking, !0) && (a = a.searchKDTree({ clientX: c.clientX, plotY: c.plotY }, !b && 1 === a.kdDimensions)) && a.series && h.push(a) }), 0 === h.length && (h = [c])) : h = [c] : u && !u.stickyTracking ?
                    (k || (f = [u]), h = this.getKDPoints(f, k, x), c = a.find(h, function(a) { return a.series === u })) : (b = a.grep(f, function(a) { return a.stickyTracking }), h = this.getKDPoints(b, k, x), u = (c = h[0]) && c.series, k && (h = this.getKDPoints(f, k, x)));
                h.sort(function(a, b) { return a.series.index - b.series.index });
                return { hoverPoint: c, hoverSeries: u, hoverPoints: h }
            },
            runPointActions: function(b, e) {
                ...
                if (m && (m !== c.hoverPoint || f && f.isHidden)) { l(c.hoverPoints || [], function(b) {-1 === a.inArray(b, x) && b.setState() });
                    l(x || [], function(a) { a.setState("hover") }); if (c.hoverSeries !== p) p.onMouseOver();
                    p && !p.directTouch && (c.hoverPoint && c.hoverPoint.firePointEvent("mouseOut"), m.firePointEvent("mouseOver"));
                    c.hoverPoints = x;
                    c.hoverPoint = m;
                    f && f.refresh(k ? x : m, b) } else u && f && !f.isHidden &&
                    (p = f.getAnchor([{}], b), f.updatePosition({ plotX: p[0], plotY: p[1] }));
                this.unDocMouseMove || (this.unDocMouseMove = D(h, "mousemove", function(b) { var c = G[a.hoverChartIndex]; if (c) c.pointer.onDocumentMouseMove(b) }));
                l(c.axes, function(c) { d(c.crosshair.snap, !0) ? a.find(x, function(a) { return a.series[c.coll] === c }) ? c.drawCrosshair(b, m) : c.hideCrosshair() : c.drawCrosshair(b) })
            },
            reset: function(a, b) {
                var c = this.chart,
                    d = c.hoverSeries,
                ...
                if (a) p && m && (p.refresh(m), e && (e.setState(e.state, !0), l(c.axes, function(a) { a.crosshair && a.drawCrosshair(null, e) })));
                else { if (e) e.onMouseOut();
                    f && l(f, function(a) { a.setState() }); if (d) d.onMouseOut();
                    p && p.hide(b);
                    this.unDocMouseMove && (this.unDocMouseMove = this.unDocMouseMove());
                    l(c.axes, function(a) { a.hideCrosshair() });
                ...
                if (this.selectionMarker) {
                    ...
                    if (this.hasDragged || d) l(c.axes, function(c) {
                        if (c.zoomEnabled && f(c.min) && (d || b[{ xAxis: "zoomX", yAxis: "zoomY" }[c.coll]])) {
                            ...
                            e[c.coll].push({ axis: c, min: Math.min(m, k), max: Math.max(m, k) });
                            y = !0
                        }
                    }), y && t(c, "selection", e, function(a) { c.zoom(w(a, d ? { animation: !1 } : null)) });
                    this.selectionMarker = this.selectionMarker.destroy();
                    d && this.scaleGroups()
                }
                c && (n(c.container, { cursor: c._cursor }), c.cancelClick = 10 < this.hasDragged, c.mouseIsDown = this.hasDragged = this.hasPinched = !1, this.pinchDown = [])
            },
            ...
            onDocumentMouseMove: function(a) { var b = this.chart,
            ...
            onContainerMouseMove: function(b) { var c = this.chart;
            ...
            inClass: function(a, b) {
                for (var c; a;) {
                    if (c = A(a, "class")) { if (-1 !== c.indexOf(b)) return !0; if (-1 !== c.indexOf("highcharts-container")) return !1 }
                    a =
                        a.parentNode
                }
            },
            onTrackerMouseOut: function(a) { var b = this.chart.hoverSeries;
                a = a.relatedTarget || a.toElement; if (!(!b || !a || b.stickyTracking || this.inClass(a, "highcharts-tooltip") || this.inClass(a, "highcharts-series-" + b.index) && this.inClass(a, "highcharts-tracker"))) b.onMouseOut() },
            onContainerClick: function(a) {
                var b = this.chart,
                    ...
                    e = b.plotTop;
                a = this.normalize(a);
                b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (t(c.series, "click", w(a, { point: c })), b.hoverPoint && c.firePointEvent("click",
                    a)) : (w(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && t(b, "click", a)))
            },
            setDOMEvents: function() {
                var b = this,
                    d = b.chart.container;
                d.onmousedown = function(a) { b.onContainerMouseDown(a) };
                ...
                a.hasTouch && (d.ontouchstart = function(a) { b.onContainerTouchStart(a) }, d.ontouchmove = function(a) { b.onContainerTouchMove(a) },
        ...
        G(a.Pointer.prototype, {
            ...
            pinchTranslateDirection: function(a, f, n, t, e, d, m, C) {
                var b = this.chart,
                    ...
                    g = !q && n[1][h],
                    r;
                n = function() {!q && 20 < Math.abs(y - K) && (p = C || Math.abs(H - g) / Math.abs(y - K));
                    E = (w - H) / p + y;
            ...
            pinch: function(a) {
                ...
                F(e, function(a) { return h.normalize(a) });
                "touchstart" === a.type ? (A(e, function(a, b) { t[b] = { chartX: a.chartX, chartY: a.chartY } }), m.x = [t[0].chartX, t[1] && t[1].chartX], m.y = [t[0].chartY, t[1] && t[1].chartY], A(w.axes, function(a) { if (a.zoomEnabled) { var b = w.bounds[a.horiz ? "h" : "v"],
                            c = a.minPixelPadding,
                            d = a.toPixels(f(a.options.min, a.dataMin)),
                            e = a.toPixels(f(a.options.max, a.dataMax)),
                            m = Math.max(d, e);
                        b.min = Math.min(a.pos, Math.min(d, e) - c);
                        b.max = Math.max(a.pos + a.len, m + c) } }), h.res = !0) : h.followTouchMove && 1 === d ? this.runPointActions(h.normalize(a)) : t.length && (b ||
                    (h.selectionMarker = b = G({ destroy: n, touch: !0 }, w.plotBox)), h.pinchTranslate(t, e, x, b, u, m), h.hasPinched = C, h.scaleGroups(x, u), h.res && (h.res = !1, this.reset(!1, 0)))
            },
            touch: function(h, l) {
                var n = this.chart,
                    t, e;
            ...
            onDocumentTouchEnd: function(f) { D[a.hoverChartIndex] && D[a.hoverChartIndex].pointer.drop(f) }
        })
    })(L);
    (function(a) {
        var D = a.addEvent,
        ...
        if (!a.hasTouch && (w.PointerEvent || w.MSPointerEvent)) {
            var e = {},
                ...
                m = function() { var b = [];
                    ...
                    a.objectEach(e, function(a) { b.push({ pageX: a.pageX, pageY: a.pageY, target: a.target }) }); return b },
                C = function(b, d, c, e) { "touch" !== b.pointerType && b.pointerType !== b.MSPOINTER_TYPE_TOUCH || !A[a.hoverChartIndex] || (e(b), e = A[a.hoverChartIndex].pointer, e[d]({ type: c, target: b.currentTarget, preventDefault: f, touches: m() })) };
            n(h.prototype, {
                ...
                onContainerPointerMove: function(a) { C(a, "onContainerTouchMove", "touchmove", function(a) { e[a.pointerId] = { pageX: a.pageX, pageY: a.pageY };
                        e[a.pointerId].target || (e[a.pointerId].target = a.currentTarget) }) },
                onDocumentPointerUp: function(a) { C(a, "onDocumentTouchEnd", "touchend", function(a) { delete e[a.pointerId] }) },
            ...
            t(h.prototype, "init", function(a, d, c) { a.call(this, d, c);
                this.hasZoom && G(d.container, { "-ms-touch-action": "none", "touch-action": "none" }) });
            t(h.prototype, "setDOMEvents", function(a) { a.apply(this);
                (this.hasZoom || this.followTouchMove) && this.batchMSEvents(D) });
            t(h.prototype, "destroy", function(a) { this.batchMSEvents(l);
                a.call(this) })
        }
    })(L);
    (function(a) {
        var D, A = a.addEvent,
            ...
            m = a.win,
            C = a.wrap;
        D = a.Legend = function(a, d) { this.init(a, d) };
        D.prototype = {
            init: function(a, d) { this.chart = a;
                this.setOptions(d);
                d.enabled && (this.render(), A(this.chart, "endResize", function() { this.legend.positionCheckboxes() })) },
            setOptions: function(a) {
                var b = t(a.padding, 8);
                this.options = a;
            ...
            update: function(a, d) { var b = this.chart;
            ...
            colorizeItem: function(b, d) {
                ...
                f && f.attr({ stroke: h });
                m && (p && m.isMarker && (x = b.pointAttribs(), d || a.objectEach(x, function(a, b) { x[b] = k })), m.attr(x))
            },
            ...
            renderTitle: function() { var a = this.options,
                    d = this.padding,
                    c = a.title,
                    e = 0;
                c.text && (this.title || (this.title = this.chart.renderer.label(c.text, d - 3, d - 4, null, null, null, a.useHTML, null, "legend-title").attr({ zIndex: 1 }).css(c.style).add(this.group)), a = this.title.getBBox(), e = a.height, this.offsetWidth = a.width, this.contentGroup.attr({ translateY: e }));
                this.titleHeight = e },
            setText: function(b) {
                var d = this.options;
                b.legendItem.attr({
            ...
            getAllItems: function() { var a = [];
                f(this.chart.series, function(b) { var c = b && b.options;
                    b && t(c.showInLegend, n(c.linkedTo) ? !1 : void 0, !0) && (a = a.concat(b.legendItems || ("point" === c.legendType ? b.data : b))) }); return a },
            adjustMargins: function(a, d) {
                var b = this.chart,
                    e = this.options,
                    m = e.align.charAt(0) + e.verticalAlign.charAt(0) +
                    e.layout.charAt(0);
                e.floating || f([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/], function(c, k) { c.test(m) && !n(a[k]) && (b[l[k]] = Math.max(b[l[k]], b.legend[(k + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][k] * e[k % 2 ? "x" : "y"] + t(e.margin, 12) + d[k])) })
            },
            render: function() {
                var a = this,
                    e = a.chart,
                ...
                a.offsetWidth = 0;
                a.lastItemY = 0;
                m || (a.group = m = c.g("legend").attr({ zIndex: 7 }).add(), a.contentGroup = c.g().attr({ zIndex: 1 }).add(m),
                    a.scrollGroup = c.g().add(a.contentGroup));
                a.renderTitle();
                h = a.getAllItems();
                d(h, function(a, b) { return (a.options && a.options.legendIndex || 0) - (b.options && b.options.legendIndex || 0) });
                ...
                l += t;
                p || (a.box = p = c.rect().addClass("highcharts-legend-box").attr({ r: z.borderRadius }).add(m), p.isNew = !0);
                p.attr({
                    stroke: z.borderColor,
                    "stroke-width": z.borderWidth || 0,
                    fill: z.backgroundColor || "none"
                }).shadow(z.shadow);
                0 < k && 0 < l && (p[p.isNew ? "attr" : "animate"](p.crisp({ x: 0, y: 0, width: k, height: l }, p.strokeWidth())), p.isNew = !1);
                p[n ? "show" : "hide"]();
                a.legendWidth = k;
                a.legendHeight = l;
                f(h, function(b) { a.positionItem(b) });
                n && m.align(w(z, { width: k, height: l }), !0, "spacingBox");
            ...
            handleOverflow: function(a) {
                var b = this,
                    ...
                    H = this.pages,
                    K, g = this.allItems,
                    r = function(a) { "number" === typeof a ? p.attr({ height: a }) : p && (b.clipRect = p.destroy(), b.contentGroup.clip());
                ...
                a > c && !1 !== l.enabled ? (this.clipHeight = h = Math.max(c - 20 - this.titleHeight -
                    k, 0), this.currentPage = t(this.currentPage, 1), this.fullHeight = a, f(g, function(a, b) { var c = a._legendItemPos[1];
                    a = Math.round(a.legendItem.getBBox().height); var d = H.length; if (!d || c - H[d - 1] > h && (K || c) !== H[d - 1]) H.push(K || c), d++;
                    b === g.length - 1 && c + a - H[d - 1] > h && H.push(c);
                    c !== K && (K = c) }), p || (p = b.clipRect = d.clipRect(0, k, 9999, 0), b.contentGroup.clip(p)), r(h), y || (this.nav = y = d.g().attr({ zIndex: 1 }).add(this.group), this.up = d.symbol("triangle", 0, 0, q, q).on("click", function() { b.scroll(-1, n) }).add(y), this.pager = d.text("", 15,
                    10).addClass("highcharts-legend-navigation").css(l.style).add(y), this.down = d.symbol("triangle-down", 0, 0, q, q).on("click", function() { b.scroll(1, n) }).add(y)), b.scroll(0), a = c) : y && (r(), this.nav = y.destroy(), this.scrollGroup.attr({ translateY: 1 }), this.clipHeight = 0);
                return a
            },
            scroll: function(a, d) {
                var b = this.pages,
                ...
                0 < a && (void 0 !== d && e(d, this.chart), this.nav.attr({
                        ...
                        translateY: m + this.padding +
                            7 + this.titleHeight,
                        visibility: "visible"
                    }), this.up.attr({ "class": 1 === a ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active" }), k.attr({ text: a + "/" + f }), this.down.attr({ x: 18 + this.pager.getBBox().width, "class": a === f ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active" }), this.up.attr({ fill: 1 === a ? h.inactiveColor : h.activeColor }).css({ cursor: 1 === a ? "default" : "pointer" }), this.down.attr({ fill: a === f ? h.inactiveColor : h.activeColor }).css({ cursor: a === f ? "default" : "pointer" }), d = -b[a - 1] + this.initialItemY,
                    this.scrollGroup.animate({ translateY: d }), this.currentPage = a, this.positionCheckboxes(d))
            }
        };
        a.LegendSymbolMixin = {
            drawRectangle: function(a, d) { var b = a.symbolHeight,
                    e = a.options.squareSymbol;
                d.legendSymbol = this.chart.renderer.rect(e ? (a.symbolWidth - b) / 2 : 0, a.baseline - b + 1, e ? b : a.symbolWidth, b, t(a.options.symbolRadius, b / 2)).addClass("highcharts-point").attr({ zIndex: 3 }).add(d.legendGroup) },
            drawLineMarker: function(a) {
                ...
                c && !1 !== c.enabled && (b = Math.min(t(c.radius, f), f), 0 === this.symbol.indexOf("url") && (c = w(c, { width: e, height: e }), b = 0), this.legendSymbol = c = k.symbol(this.symbol, d / 2 - b, a - b, 2 * b, 2 * b, c).addClass("highcharts-point").add(m), c.isMarker = !0)
            }
        };
        (/Trident\/7\.0/.test(m.navigator.userAgent) || h) &&
        C(D.prototype, "positionItem", function(a, d) { var b = this,
                e = function() { d._legendItemPos && a.call(b, d) };
            e();
            setTimeout(e) })
    })(L);
    (function(a) {
        ...
        C(P.prototype, {
            ...
            isInsidePlot: function(a, b, c) { var d = c ? b : a;
                a = c ? a : b; return 0 <= d && d <= this.plotWidth && 0 <= a && a <= this.plotHeight },
            redraw: function(b) {
                var c = this.axes,
                    d = this.series,
                    g = this.pointer,
                ...
                this.layOutTitles();
                for (b = d.length; b--;)
                    if (r = d[b], r.options.stacking && (f = !0, r.isDirty)) { k = !0; break }
                if (k)
                    for (b = d.length; b--;) r = d[b], r.options.stacking && (r.isDirty = !0);
                m(d, function(a) { a.isDirty && "point" === a.options.legendType && (a.updateTotals && a.updateTotals(), q = !0);
                    a.isDirtyData && x(a, "updatedData") });
                q && e.options.enabled && (e.render(), this.isDirtyLegend = !1);
                f && this.getStacks();
                p && m(c, function(a) { a.updateNames();
                    a.setScale() });
                this.getMargins();
                p && (m(c,
                    function(a) { a.isDirty && (y = !0) }), m(c, function(a) { var b = a.min + "," + a.max;
                    a.extKey !== b && (a.extKey = b, l.push(function() { x(a, "afterSetExtremes", C(a.eventArgs, a.getExtremes()));
                        delete a.eventArgs }));
                    (y || f) && a.redraw() }));
                y && this.drawChartBox();
                x(this, "predraw");
            ...
            getAxes: function() { var a = this,
                    ...
                    c = b.xAxis = r(b.xAxis || {}),
                    b = b.yAxis = r(b.yAxis || {});
                m(c, function(a, b) { a.index = b;
                    a.isX = !0 });
                m(b, function(a, b) { a.index = b });
                c = c.concat(b);
                m(c, function(b) { new f(a, b) }) },
            getSelectedPoints: function() { var a = [];
                m(this.series, function(b) { a = a.concat(u(b.data || [], function(a) { return a.selected })) }); return a },
            ...
            setTitle: function(a, b, c) {
                var d = this,
                    g = d.options,
                    e;
                e = g.title = z({ style: { color: "#333333", fontSize: g.isStock ? "16px" : "18px" } }, g.title, a);
                g = g.subtitle = z({ style: { color: "#666666" } }, g.subtitle, b);
                m([
                    ["title", a, e],
                    ["subtitle", b, g]
                ], function(a, b) {
                    ...
                    a = a[2];
                    g && e && (d[c] = g = g.destroy());
                    a && a.text && !g && (d[c] = d.renderer.text(a.text, 0, 0, a.useHTML).attr({ align: a.align, "class": "highcharts-" + c, zIndex: a.zIndex || 4 }).add(), d[c].update = function(a) {
                        d.setTitle(!b && a, b &&
                            a)
                    }, d[c].css(a.style))
                });
            ...
            layOutTitles: function(a) {
                var b = 0,
                    c, d = this.renderer,
                    g = this.spacingBox;
                m(["title", "subtitle"], function(a) { var c = this[a],
                        e = this.options[a];
                    a = "title" === a ? -3 : e.verticalAlign ? 0 : b + 2; var q;
                    c && (q = e.style.fontSize, q = d.fontMetrics(q, c).b, c.css({ width: (e.width || g.width + e.widthAdjust) + "px" }).align(C({ y: a + q }, e), !1, "spacingBox"), e.floating || e.verticalAlign || (b = Math.ceil(b + c.getBBox(e.useHTML).height))) }, this);
                c = this.titleOffset !== b;
                this.titleOffset = b;
                !this.isDirtyBox &&
                    c && (this.isDirtyBox = c, this.hasRendered && y(a, !0) && this.isDirtyBox && this.redraw())
            },
            getChartSize: function() { var b = this.options.chart,
                    g = b.width,
                    b = b.height,
                    e = this.renderTo;
            ...
            temporaryDisplay: function(b) {
                ...
                if (b)
                    ...
                    for (; d && d.style;) "none" === c(d, "display", !1) && (d.hcOrigStyle = { display: d.style.display, height: d.style.height, overflow: d.style.overflow }, a.css(d, { display: "block", height: 0, overflow: "hidden" }), d.style.setProperty && d.style.setProperty("display", "block", "important")), d = d.parentNode
            },
            ...
            getContainer: function() {
                ...
                g = this.chartWidth;
                e = this.chartHeight;
                f = C({ position: "relative", overflow: "hidden", width: g + "px", height: e + "px", textAlign: "left", lineHeight: "normal", zIndex: 0, "-webkit-tap-highlight-color": "rgba(0,0,0,0)" }, d.style);
                this.container = b = h("div", { id: q }, f, b);
            ...
            getAxisMargins: function() { var a = this,
                ...
                m(p, function(g, e) { d(c[e]) || (a[g] += b[e]) });
                a.setChartSize() },
            reflow: function(a) {
                var b = this,
                    g = b.options.chart,
                    ...
                    e = a ? a.target :
                    N;
                if (!q && !b.isPrinting && f && g && (e === N || e === n)) { if (f !== b.containerWidth || g !== b.containerHeight) clearTimeout(b.reflowTimeout), b.reflowTimeout = J(function() { b.container && b.setSize(void 0, void 0, !1) }, a ? 100 : 0);
                    b.containerWidth = f;
                    b.containerHeight = g }
            },
            initReflow: function() { var a = this,
                    b;
                b = D(N, "resize", function(b) { a.reflow(b) });
                D(a, "destroy", b) },
            setSize: function(b, c, d) {
                ...
                g.getChartSize();
                b = q.globalAnimation;
                (b ? A : e)(g.container, { width: g.chartWidth + "px", height: g.chartHeight + "px" }, b);
                g.setChartSize(!0);
                q.setSize(g.chartWidth, g.chartHeight, d);
                m(g.axes, function(a) { a.isDirty = !0;
                    a.setScale() });
                g.isDirtyLegend = !0;
                g.isDirtyBox = !0;
                g.layOutTitles();
                ...
                x(g, "resize");
                J(function() { g && x(g, "endResize", null, function() {--g.isResizing }) }, G(b).duration)
            },
            setChartSize: function(a) {
                ...
                this.spacingBox = c.spacingBox = { x: q[3], y: q[0], width: d - q[3] - q[1], height: g - q[0] - q[2] };
                this.plotBox =
                    c.plotBox = { x: k, y: p, width: y, height: r };
                ...
                a || m(this.axes, function(a) { a.setAxisSize();
            ...
            resetMargins: function() {
                ...
                m(["margin", "spacing"], function(c) {
                    ...
                    m(["Top", "Right", "Bottom", "Left"],
                        function(d, e) { a[c][e] = y(b[c + d], g[e]) })
                });
                m(p, function(b, c) { a[b] = y(a.margin[c], a.spacing[c]) });
            ...
            drawChartBox: function() {
                ...
                g[t]({ x: r / 2, y: r / 2, width: c - r - f % 2, height: d - r - f % 2, r: a.borderRadius });
                t = "animate";
                e || (t = "attr", this.plotBackground = e = b.rect().addClass("highcharts-plot-background").add());
                e[t](x);
                e.attr({ fill: p || "none" }).shadow(a.plotShadow);
                y && (k ? k.animate(x) : this.plotBGImage =
                    b.image(y, h, l, n, H).add());
                u ? u.animate({ width: z.width, height: z.height }) : this.clipRect = b.clipRect(z);
                t = "animate";
                q || (t = "attr", this.plotBorder = q = b.rect().addClass("highcharts-plot-border").attr({ zIndex: 1 }).add());
                q.attr({ stroke: a.plotBorderColor, "stroke-width": a.plotBorderWidth || 0, fill: "none" });
                q[t](q.crisp({ x: h, y: l, width: n, height: H }, -q.strokeWidth()));
                this.isDirtyBox = !1
            },
            ...
            linkSeries: function() { var a = this,
                    b = a.series;
                m(b, function(a) { a.linkedSeries.length = 0 });
                m(b, function(b) { var c = b.options.linkedTo;
            ...
            renderSeries: function() { m(this.series, function(a) { a.translate();
                    a.render() }) },
            renderLabels: function() { var a = this,
                    b = a.options.labels;
                b.items && m(b.items, function(c) { var d = C(b.style, c.style),
            ...
            render: function() {
                ...
                if (g || e) m(a, function(a) {
                    (a.horiz && g || !a.horiz && e) && a.setTickInterval(!0) }), this.getMargins();
                this.drawChartBox();
            ...
            addCredits: function(a) {
                ...
                a = z(!0, this.options.credits,
                    a);
                a.enabled && !this.credits && (this.credits = this.renderer.text(a.text + (this.mapCredits || ""), 0, 0).addClass("highcharts-credits").on("click", function() { a.href && (N.location.href = a.href) }).attr({ align: a.position.align, zIndex: 8 }).css(a.style).add().align(a.position), this.credits.update = function(a) { b.credits = b.credits.destroy();
                    b.addCredits(a) })
            },
            destroy: function() {
                var b = this,
                ...
                m("title subtitle chartBackground plotBackground plotBGImage plotBorder seriesGroup clipRect credits pointer rangeSelector legend resetZoomButton tooltip renderer".split(" "), function(a) { var c = b[a];
            ...
            isReadyToRender: function() {
                var a =
                    this;
                return R || N != N.top || "complete" === n.readyState ? !0 : (n.attachEvent("onreadystatechange", function() { n.detachEvent("onreadystatechange", a.firstRender); "complete" === n.readyState && a.firstRender() }), !1)
            },
            firstRender: function() {
                ...
                if (a.isReadyToRender()) {
                    ...
                    a.propFromSeries();
                    a.getAxes();
                    m(b.series || [], function(b) { a.initSeries(b) });
                    a.linkSeries();
                    x(a, "beforeRender");
            ...
            onload: function() { m([this.callback].concat(this.callbacks), function(a) { a && void 0 !== this.index && a.apply(this, [this]) }, this);
                x(this, "load");
                x(this, "render");
    ...
    (function(a) {
        ...
        D.prototype = {
            ...
            getZone: function() { var a = this.series,
                    ...
                    a = a.zoneAxis || "y",
                    f = 0,
                    h; for (h = d[f]; this[a] >= h.value;) h = d[++f];
            ...
            destroyElements: function() { for (var a = ["graphic", "dataLabel", "dataLabelUpper", "connector", "shadowGroup"], d, f = 6; f--;) d = a[f], this[d] && (this[d] = this[d].destroy()) },
            ...
            tooltipFormatter: function(a) {
                var d = this.series,
                    ...
                    b = e.valuePrefix || "",
                    l = e.valueSuffix || "";
                A(d.pointArrayMap || ["y"], function(c) { c = "{point." + c; if (b || l) a = a.replace(c + "}", b + c + "}" + l);
                    a = a.replace(c + "}", c + ":,." + h + "f}") });
            ...
            firePointEvent: function(a, d, f) {
                ...
                "click" === a && b.allowPointSelect && (f = function(a) { e.select && e.select(null, a.ctrlKey || a.metaKey || a.shiftKey) });
                n(this,
                    a, d, f)
            },
            visible: !0
    ...
    (function(a) {
        ...
        a.Series = a.seriesType("line", null, {
            ...
            init: function(a, b) {
                ...
                c.linkedSeries = [];
                c.bindAxes();
                d(c, { name: b.name, state: "", visible: !1 !== b.visible, selected: !0 === b.selected });
                e = b.events;
                B(e, function(a,
                    b) { D(c, b, a) });
            ...
            insert: function(a) {
                var b = this.options.index,
                    c;
                if (x(b)) { for (c = a.length; c--;)
                        if (b >= I(a[c].options.index, a[c]._i)) { a.splice(c + 1, 0, this); break } - 1 === c && a.unshift(this);
            ...
            bindAxes: function() { var b = this,
                    ...
                    d = b.chart,
                    e;
                t(b.axisTypes || [], function(g) { t(d[g], function(a) { e = a.options; if (c[g] === e.index || void 0 !== c[g] && c[g] === e.id || void 0 === c[g] && 0 === e.index) b.insert(a.series), b[g] = a, a.isDirty = !0 });
                    b[g] || b.optionalAxis === g || a.error(18, !0) }) },
            updateParallelArrays: function(a, b) {
                var c = a.series,
                    d = arguments,
                    g = x(b) ? function(d) { var g = "y" === d && c.toYData ? c.toYData(a) : a[d];
                        c[d + "Data"][b] = g } : function(a) {
            ...
            getColor: function() { this.options.colorByPoint ? this.options.color = null : this.getCyclic("color", this.options.color || l[this.type].color, this.chart.options.colors) },
            ...
            setData: function(d, e, f, k) {
                ...
                p = d.length;
                e = I(e, !0);
                if (!1 !== k && p && m === p && !g.cropped && !g.hasGroupedData && g.visible) t(d, function(a, b) { q[b].update && a !== h.data[b] && q[b].update(a, !1, null, !1) });
                else {
                    g.xIncrement = null;
                    g.colorCounter = 0;
                    t(this.parallelArrays, function(a) { g[a + "Data"].length = 0 });
                    if (u && p > u) {
                        ...
                        for (f = 0; f < p; f++) void 0 !== d[f] && (l = { series: g }, g.pointClass.prototype.applyOptions.apply(l, [d[f]]), g.updateParallelArrays(l, f));
                    c(H[0]) && a.error(14, !0);
                    g.data = [];
            ...
            cropData: function(a, b, c, d) { var g = a.length,
                    e = 0,
                    f = g,
                    q = I(this.cropShoulder, 1),
                    k; for (k = 0; k < g; k++)
                    if (a[k] >= c) { e = Math.max(0, k - q); break }
                for (c = k; c < g; c++)
                    if (a[c] > d) { f = c + q; break }
                return { xData: a.slice(e, f), yData: b.slice(e, f), start: e, end: f } },
            ...
            setClip: function(a) {
                var b = this.chart,
                    ...
                    k = b[q],
                    m = b[q + "m"];
                k || (a && (f.width = 0, b[q + "m"] = m = d.clipRect(-99, g ? -b.plotLeft : -b.plotTop, 99, g ? b.chartWidth : b.chartHeight)), b[q] = k = d.clipRect(f), k.count = { length: 0 });
            ...
            animate: function(a) { var b = this.chart,
            ...
            destroy: function() {
                ...
                B(a, function(a, b) { a instanceof p && !a.survive && (d = c && "group" === b ? "hide" : "destroy", a[d]()) });
            ...
            drawGraph: function() {
                ...
                t(d, function(d, e) { var g = d[0],
                        f = a[g];
                    f ? (f.endX = c.xMap, f.animate({ d: c })) : c.length && (a[g] = a.chart.renderer.path(c).addClass(d[1]).attr({ zIndex: 1 }).add(a.group), f = { stroke: d[2], "stroke-width": b.lineWidth, fill: a.fillGraph && a.color || "none" }, d[3] ? f.dashstyle = d[3] : "square" !== b.linecap && (f["stroke-linecap"] = f["stroke-linejoin"] = "round"), f = a[g].attr(f).shadow(2 > e && b.shadow));
            ...
            applyZones: function() {
                ...
                d.length && (m || p) && l && void 0 !== l.min && (u = l.reversed, z = l.horiz, m && m.hide(), p && p.hide(), n = l.getExtremes(), t(d, function(d, q) {
                    ...
                    B = Math.max(g,
                        e);
                    l.isXAxis ? (k = { x: x ? B : w, y: 0, width: E, height: h }, z || (k.x = b.plotHeight - k.x)) : (k = { x: 0, y: x ? B : w, width: h, height: E }, z && (k.y = b.plotWidth - k.y));
                    x && c.isVML && (k = l.isXAxis ? { x: 0, y: u ? w : B, height: k.width, width: b.chartWidth } : { x: k.y - b.plotLeft - b.spacingBox.x, y: 0, width: k.height, height: b.chartHeight });
            ...
            plotGroup: function(a, b, c, d, g) {
                var e = this[a],
                    f = !e;
                f && (this[a] = e = this.chart.renderer.g().attr({ zIndex: d || .1 }).add(g));
                ...
                e.attr({ visibility: c })[f ? "attr" : "animate"](this.getPlotBox());
                return e
            },
            getPlotBox: function() { var a = this.chart,
                    b = this.xAxis,
                    c = this.yAxis;
            ...
            render: function() {
                ...
                g && a.animate();
                k || (a.animationTimeout = z(function() { a.afterAnimate() }, g));
                a.isDirty = !1;
                a.hasRendered = !0
            },
            redraw: function() {
                var a = this.chart,
                    ...
                    d = this.xAxis,
                    g = this.yAxis;
                c && (a.inverted && c.attr({ width: a.plotWidth, height: a.plotHeight }), c.animate({ translateX: I(d && d.left, a.plotLeft), translateY: I(g && g.top, a.plotTop) }));
                this.translate();
                this.render();
                b && delete this.kdTree
            },
            kdAxisArray: ["clientX", "plotY"],
            searchPoint: function(a, b) { var c = this.xAxis,
                    d = this.yAxis,
                    g = this.chart.inverted; return this.searchKDTree({ clientX: g ? c.len - a.chartY + c.pos : a.chartX - c.pos, plotY: g ? d.len - a.chartX + d.pos : a.chartY - d.pos }, b) },
            buildKDTree: function() {
                function a(c,
                    d, e) { var g, f; if (f = c && c.length) return g = b.kdAxisArray[d % e], c.sort(function(a, b) { return a[g] - b[g] }), f = Math.floor(f / 2), { point: c[f], left: a(c.slice(0, f), d + 1, e), right: a(c.slice(f + 1), d + 1, e) } }
    ...
    (function(a) {
        function D(a, d, f, h, b) { var e = a.chart.inverted;
            this.axis = a;
            this.isNegative = f;
            this.options = d;
            this.x = h;
            ...
            this.alignOptions = { align: d.align || (e ? f ? "left" : "right" : "center"), verticalAlign: d.verticalAlign || (e ? "middle" : f ? "bottom" : "top"), y: t(d.y, e ? 4 : f ? 14 : -6), x: t(d.x, e ? f ? -6 : 6 : 0) };
        ...
        D.prototype = {
            ...
            render: function(a) { var d = this.options,
                    e = d.format,
                    e = e ? l(e, this) : d.formatter.call(this);
                this.label ? this.label.attr({ text: e, visibility: "hidden" }) : this.label = this.axis.chart.renderer.text(e, null, null, d.useHTML).css(d.style).attr({ align: this.textAlign, rotation: d.rotation, visibility: "hidden" }).add(a) },
            setOffset: function(a, d) {
                ...
                var l = f.plotHeight,
                    b = { x: b ? h ? c : c - e : a, y: b ? l - a - d : h ? l - c - e : l - c, width: b ? e : d, height: b ? d : e };
        ...
        G.prototype.getStacks = function() {
            ...
            h(a.series, function(d) {!d.options.stacking || !0 !== d.visible && !1 !== a.options.chart.ignoreHiddenSeries || (d.stackKey = d.type + t(d.options.stack, "")) })
        };
        A.prototype.buildStacks = function() { var a = this.series,
                d, f = t(this.options.reversedStacks, !0),
                h = a.length,
                b; if (!this.isXAxis) { this.usePercentage = !1; for (b = h; b--;) a[f ? b : h - b - 1].setStackedPoints(); for (b = h; b--;) d = a[f ? b : h - b - 1], d.setStackCliffs && d.setStackCliffs(); if (this.usePercentage)
        ...
        A.prototype.renderStackTotals =
            function() { var a = this.chart,
                ...
                h || (this.stackTotalGroup = h = d.g("stack-labels").attr({ visibility: "visible", zIndex: 6 }).add());
                h.translate(a.plotLeft, a.plotTop);
                w(f, function(a) { w(a, function(a) { a.render(h) }) }) };
        A.prototype.resetStacks = function() { var a = this,
                d = a.stacks;
            a.isXAxis || w(d, function(d) { w(d, function(e, b) { e.touched < a.stacksTouched ? (e.destroy(), delete d[b]) : (e.total = null, e.cum = null) }) }) };
        A.prototype.cleanStacks = function() {
            var a;
            this.isXAxis || (this.oldStacks &&
                (a = this.stacks = this.oldStacks), w(a, function(a) { w(a, function(a) { a.cum = a.total }) }))
        };
        ...
        a.prototype.getStackIndicator = function(a, d, f, h) {!n(a) || a.x !== d || h && a.key !== h ? a = { x: d, index: 0, key: h } : a.index++;
            a.key = [f, d, a.index].join(); return a }
    })(L);
    (function(a) {
        var D = a.addEvent,
            A = a.animate,
        ...
        w(a.Chart.prototype, {
            addSeries: function(a, b,
                d) { var e, f = this;
                a && (b = c(b, !0), t(f, "addSeries", { options: a }, function() { e = f.initSeries(a);
                    f.isDirtyLegend = !0;
                    f.linkSeries();
                    b && f.redraw(d) })); return e },
            addAxis: function(a, d, e, f) { var k = d ? "xAxis" : "yAxis",
                    p = this.options;
                a = b(a, { index: this[k].length, isX: d });
                new G(this, a);
                p[k] = E(p[k] || {});
                p[k].push(a);
                c(e, !0) && this.redraw(f) },
            showLoading: function(a) {
                var b = this,
                    ...
                    d = b.loadingDiv,
                    e = c.loading,
                    f = function() { d && n(d, { left: b.plotLeft + "px", top: b.plotTop + "px", width: b.plotWidth + "px", height: b.plotHeight + "px" }) };
                d || (b.loadingDiv = d = F("div", { className: "highcharts-loading highcharts-loading-hidden" }, null, b.container), b.loadingSpan = F("span", { className: "highcharts-loading-inner" }, null, d), D(b, "redraw", f));
                d.className = "highcharts-loading";
                b.loadingSpan.innerHTML = a || c.lang.loading;
                n(d, w(e.style, { zIndex: 10 }));
                n(b.loadingSpan, e.labelStyle);
                b.loadingShown || (n(d, { opacity: 0, display: "" }), A(d, { opacity: e.style.opacity || .5 }, { duration: e.showDuration || 0 }));
                b.loadingShown = !0;
                f()
            },
            hideLoading: function() {
                var a = this.options,
                    b =
                    this.loadingDiv;
                b && (b.className = "highcharts-loading highcharts-loading-hidden", A(b, { opacity: 0 }, { duration: a.loading.hideDuration || 100, complete: function() { n(b, { display: "none" }) } }));
                this.loadingShown = !1
            },
            ...
            update: function(a, k) {
                var p = this,
                    ...
                    l = a.chart,
                    n, u;
                if (l) { b(!0, p.options.chart, l); "className" in l && p.setClassName(l.className); if ("inverted" in l || "polar" in l) p.propFromSeries(), n = !0; "alignTicks" in l && (n = !0);
                    x(l, function(a, b) {-1 !== e("chart." + b, p.propsRequireUpdateSeries) && (u = !0); - 1 !== e(b, p.propsRequireDirtyBox) && (p.isDirtyBox = !0) }); "style" in l && p.renderer.setStyle(l.style) }
                a.colors && (this.options.colors = a.colors);
                a.plotOptions && b(!0, this.options.plotOptions,
                    a.plotOptions);
                x(a, function(a, b) { if (p[b] && "function" === typeof p[b].update) p[b].update(a, !1);
                    else if ("function" === typeof p[m[b]]) p[m[b]](a); "chart" !== b && -1 !== e(b, p.propsRequireUpdateSeries) && (u = !0) });
                h("xAxis yAxis zAxis series colorAxis pane".split(" "), function(b) { a[b] && h(E(a[b]), function(a, c) {
                        (c = f(a.id) && p.get(a.id) || p[b][c]) && c.coll === b && c.update(a, !1) }) });
                n && h(p.axes, function(a) { a.update({}, !1) });
                u && h(p.series, function(a) { a.update({}, !1) });
        ...
        w(B.prototype, {
            ...
            removePoint: function(a, b, d) {
                var e = this,
                    ...
                    h = e.points,
                    g = e.chart,
                    m = function() { h && h.length === f.length && h.splice(a, 1);
                        f.splice(a, 1);
            ...
            remove: function(a, b, d) {
                function e() { f.destroy();
                    k.isDirtyLegend = k.isDirtyBox = !0;
                    k.linkSeries();
                    c(a, !0) && k.redraw(b) } var f = this,
                    k = f.chart;!1 !== d ? t(f, "remove", null, e) : e() },
            update: function(a, d) {
                var e = this,
                    f = e.chart,
                    k = e.userOptions,
                ...
                h(l, function(a) { l[a] = e[a];
                    delete e[a] });
                a = b(k, { animation: !1, index: e.index, pointStart: e.xData[0] }, { data: e.options.data }, a);
                e.remove(!1, null, !1);
                for (n in g) e[n] = void 0;
                w(e, I[m || p].prototype);
                h(l, function(a) { e[a] = l[a] });
                e.init(f, a);
                e.oldType = p;
                f.linkSeries();
                c(d, !0) && f.redraw(!1)
        ...
        w(G.prototype, {
            update: function(a, d) {
                ...
                this.destroy(!0);
                this.init(e, w(a, { events: void 0 }));
                e.isDirtyBox = !0;
                c(d, !0) && e.redraw()
            },
            remove: function(a) { for (var b = this.chart, d = this.coll, e = this.series, f = e.length; f--;) e[f] && e[f].remove(!1);
                l(b.axes, this);
                l(b[d], this);
                C(b.options[d]) ? b.options[d].splice(this.options.index, 1) : delete b.options[d];
                h(b[d], function(a, b) { a.options.index = b });
                this.destroy();
                b.isDirtyBox = !0;
                c(a, !0) && b.redraw() },
        ...
        f("area", "line", { softThreshold: !1, threshold: 0 }, {
            ...
            getStackPoints: function() {
                ...
                if (this.options.stacking) {
                    ...
                    a.objectEach(e, function(a, b) { null !== a.total && l.push(b) });
                    l.sort(function(a, b) { return a - b });
                    c = G(b,
                        function() { return this.visible });
                    A(l, function(a, b) { var k = 0,
                            h, m; if (d[a] && !d[a].isNull) f.push(d[a]), A([-1, 1], function(f) { var k = 1 === f ? "rightNull" : "leftNull",
                                p = 0,
                                n = e[l[b + f]]; if (n)
                                for (B = C; 0 <= B && B < x;) h = n.points[B], h || (B === C ? d[a][k] = !0 : c[B] && (m = e[a].points[B]) && (p -= m[1] - m[0])), B += u;
                            d[a][1 === f ? "rightCliff" : "leftCliff"] = p });
                        else { for (B = C; 0 <= B && B < x;) { if (h = e[a].points[B]) { k = h[1]; break }
                                B += u }
                            k = t.translate(k, 0, 1, 0, 1);
                            f.push({ isNull: !0, plotX: n.translate(a, 0, 0, 0, 1), x: a, plotY: k, yBottom: k }) } })
                }
                return f
            },
            getGraphPath: function(a) {
                var f =
                    ...
                    E = function(d, f, k) {
                        ...
                        void 0 !== m && (b.push({ plotX: c, plotY: null === m ? A : e.getThreshold(m), isNull: h, isCliff: !0 }), C.push({
                            plotX: c,
                ...
                for (d = 0; d < a.length; d++)
                    if (m = a[d].isNull, c = F(a[d].rectPlotX, a[d].plotX), k = F(a[d].yBottom, A), !m || h) h || E(d, d - 1, "left"), m && !t && h || (b.push(a[d]), C.push({ x: d, plotX: c, plotY: k })), h || E(d, d + 1, "right");
                d = f.call(this, b, !0, !0);
                C.reversed = !0;
                m = f.call(this, C, !0, !0);
                m.length && (m[0] = "L");
            ...
            drawGraph: function() {
                ...
                A(this.zones, function(e, d) { t.push(["zone-area-" + d, "highcharts-area highcharts-zone-area-" + d + " " + e.className, e.color || a.color, e.fillColor || w.fillColor]) });
                A(t, function(e) { var d = e[0],
                        h = a[d];
                    h ? (h.endX = f.xMap, h.animate({ d: f })) : (h = a[d] = a.chart.renderer.path(f).addClass(e[1]).attr({ fill: F(e[3], D(e[2]).setOpacity(F(w.fillOpacity, .75)).get()), zIndex: 0 }).add(a.group), h.isArea = !0);
                    h.startX = f.xMap;
    ...
    (function(a) { var D = a.seriesTypes.area.prototype,
            A = a.seriesType;
        A("areaspline", "spline", a.defaultPlotOptions.area, { getStackPoints: D.getStackPoints, getGraphPath: D.getGraphPath, setStackCliffs: D.setStackCliffs, drawGraph: D.drawGraph, drawLegendSymbol: a.LegendSymbolMixin.drawRectangle }) })(L);
    (function(a) {
        var D = a.animObject,
            A = a.color,
            G = a.each,
        ...
        w("column", "line", { borderRadius: 0, crisp: !0, groupPadding: .2, marker: null, pointPadding: .1, minPointLength: 0, cropThreshold: 50, pointRange: null, states: { hover: { halo: !1, brightness: .1, shadow: !1 }, select: { color: "#cccccc", borderColor: "#000000", shadow: !1 } }, dataLabels: { align: null, verticalAlign: null, y: null }, softThreshold: !1, startFromThreshold: !0, stickyTracking: !1, tooltip: { distance: 6 }, threshold: 0, borderColor: "#ffffff" }, {
            ...
            negStacks: !0,
            init: function() { l.prototype.init.apply(this, arguments); var a = this,
                    d = a.chart;
                d.hasRendered && G(d.series, function(d) { d.type === a.type && (d.isDirty = !0) }) },
            getColumnMetrics: function() {
                ...
                a.columnMetrics = { width: d, offset: (k - d) / 2 + (w + ((a.columnIndex || 0) + (b ? 1 : 0)) * k - t / 2) * (b ? -1 : 1) };
            ...
            crispCol: function(a, d, f, h) {
                ...
                h -= d;
                c && h && (--d, h += 1);
                return { x: a, y: d, width: f, height: h }
            },
            translate: function() {
                var a = this,
                    d = a.chart,
            ...
            pointAttribs: function(a, d) {
                ...
                h = { fill: c, stroke: n, "stroke-width": t };
            ...
            animate: function(a) {
                var d = this,
                    ...
                    h = {};
                t && (a ? (h.scaleY = .001, a = Math.min(e.pos + e.len, Math.max(e.pos, e.toPixels(f.threshold))), b ? h.translateX = a - e.len : h.translateY = a, d.group.attr(h)) : (h[b ? "translateX" : "translateY"] = e.pos, d.group.animate(h, F(D(d.options.animation), { step: function(a, b) { d.group.attr({ scaleY: Math.max(.001, b.pos) }) } })), d.animate = null))
            },
        ...
        t("pie", "line", {
            ...
            animate: function(a) {
                ...
                a || (G(e, function(a) {
                    var c = a.graphic,
                        e = a.shapeArgs;
                    c && (c.attr({ r: a.startR || d.center[3] / 2, start: b, end: b }), c.animate({ r: e.r, start: e.start, end: e.end }, d.options.animation))
                }), d.animate = null)
            },
            updateTotals: function() { var a, e = 0,
                    f = this.points,
                    b = f.length,
                    h, c = this.options.ignoreHiddenPoint; for (a = 0; a < b; a++) h = f[a], e += c && !h.visible ? 0 : h.isNull ? 0 : h.y;
                this.total = e; for (a = 0; a < b; a++) h = f[a], h.percentage = 0 < e && (h.visible || !c) ? h.y / e * 100 : 0, h.total = e },
            ...
            translate: function(a) {
                ...
                this.getX = function(b, c, d) { n = Math.asin(Math.min((b - a[1]) / (a[2] / 2 + d.labelDistance), 1)); return a[0] + (c ? -1 : 1) * Math.cos(n) * (a[2] / 2 + d.labelDistance) };
                for (A = 0; A < q; A++) {
                    y = w[A];
                    ...
                    l = k + d * t;
                    y.shapeType = "arc";
                    y.shapeArgs = { x: a[0], y: a[1], r: a[2] / 2, innerR: a[3] / 2, start: Math.round(1E3 * c) / 1E3, end: Math.round(1E3 * l) / 1E3 };
                    n = (l + c) / 2;
                    n > 1.5 * Math.PI ? n -= 2 * Math.PI : n < -Math.PI / 2 && (n += 2 * Math.PI);
                    y.slicedTranslation = { translateX: Math.round(Math.cos(n) * b), translateY: Math.round(Math.sin(n) * b) };
                    l = Math.cos(n) * a[2] / 2;
                    p = Math.sin(n) * a[2] / 2;
                    y.tooltipPos = [a[0] +
                        .7 * l, a[1] + .7 * p
            ...
            drawPoints: function() {
                ...
                G(a.points, function(d) {
                    if (!d.isNull) {
                        ...
                        b ? b.setRadialReference(a.center).attr(h).animate(F(c, f)) : (d.graphic = b = e[d.shapeType](c).setRadialReference(a.center).attr(f).add(a.group), d.visible || b.attr({ visibility: "hidden" }), b.attr(h).attr({ "stroke-linejoin": "round" }).shadow(l, m));
            ...
            init: function() { l.prototype.init.apply(this, arguments); var a = this,
                ...
                e = function(d) { a.slice("select" === d.type) };
                D(a, "select", e);
                D(a, "unselect", e); return a },
            ...
            setVisible: function(a, e) {
                ...
                a !== d.visible && (d.visible = d.options.visible =
                    a = void 0 === a ? !d.visible : a, b.options.data[n(d, b.data)] = d.options, G(["graphic", "dataLabel", "connector", "shadowGroup"], function(b) { if (d[b]) d[b][a ? "show" : "hide"](!0) }), d.legendItem && f.legend.colorizeItem(d, a), a || "hover" !== d.state || d.setState(""), c && (b.isDirty = !0), e && f.redraw())
            },
            slice: function(a, f, l) { var b = this.series;
                e(l, b.chart);
                h(f, !0);
    ...
    (function(a) {
        ...
        a.distribute = function(a, d) {
            ...
            if (n > d) { C(a, function(a, b) { return (b.rank || 0) - (a.rank || 0) }); for (n = e = 0; n <= d;) n += a[e].size, e++;
                k = a.splice(e - 1, a.length) }
            C(a, b);
            for (a = h(a, function(a) { return { size: a.size, targets: [a.target] } }); f;) {
            ...
            e = 0;
            F(a, function(a) { var b = 0;
                F(a.targets, function() { l[e].pos = a.pos + b;
                    b += l[e].size;
                    e++ }) });
            l.push.apply(l, k);
            C(l, b)
        ...
        d.prototype.drawDataLabels = function() {
            ...
            if (c.enabled || b._hasPointLabels) b.dlProcessOptions && b.dlProcessOptions(c), p = b.plotGroup("dataLabelsGroup", "data-labels",
                z && !k ? "hidden" : "visible", c.zIndex || 6), z && (p.attr({ opacity: +k }), k || D(b, "afterAnimate", function() { b.visible && p.show(!0);
                p[d.animation ? "animate" : "attr"]({ opacity: 1 }, { duration: 200 }) })), n = c, F(e, function(e) {
                var k, q = e.dataLabel,
                    u, g, r = e.connector,
                    x = !q,
                    z;
        ...
        d.prototype.alignDataLabel = function(a, d, c, e, f) {
            ...
            if (x && (m = c.style.fontSize, m = b.renderer.fontMetrics(m, d).b, e = n({ x: k ? b.plotWidth - p : h, y: Math.round(k ? b.plotHeight - h : p), width: 0, height: 0 }, e), n(c, { width: l.width, height: l.height }), q ? (w = !1, h = b.renderer.rotCorr(m, q), h = { x: e.x + c.x + e.width / 2 + h.x, y: e.y + c.y + { top: 0, middle: .5, bottom: 1 }[c.verticalAlign] * e.height }, d[f ? "attr" : "animate"](h).attr({ align: u }), p = (q + 720) % 360, p = 180 < p && 360 > p, "left" === u ? h.y -= p ? l.height : 0 : "center" === u ? (h.x -= l.width / 2, h.y -= l.height / 2) : "right" === u && (h.x -= l.width, h.y -= p ?
                    0 : l.height)) : (d.align(c, null, e), h = d.alignAttr), w ? a.isLabelJustified = this.justifyDataLabel(d, c, h, l, e, f) : t(c.crop, !0) && (x = b.isInsidePlot(h.x, h.y) && b.isInsidePlot(h.x + l.width, h.y + l.height)), c.shape && !q)) d[f ? "attr" : "animate"]({ anchorX: k ? b.plotWidth - a.plotY : a.plotX, anchorY: k ? b.plotHeight - a.plotX : a.plotY });
            x || (d.attr({ y: -9999 }), d.placed = !1)
        };
        ...
        m.pie && (m.pie.prototype.drawDataLabels = function() {
                var b = this,
                    ...
                    J, N, O, P, v = [0, 0, 0, 0];
                b.visible && (h.enabled || b._hasPointLabels) && (F(e, function(a) { a.dataLabel && a.visible && a.dataLabel.shortened && (a.dataLabel.attr({ width: "auto" }).css({ width: "auto", textOverflow: "clip" }), a.dataLabel.shortened = !1) }), d.prototype.drawDataLabels.apply(b), F(e, function(a) { a.dataLabel && a.visible && (L[a.half].push(a), a.dataLabel._pos = null) }), F(L, function(d, e) {
                        var k, m, t = d.length,
                            u = [],
                            x;
                        if (t)
                            for (b.sortByAngle(d, e - .5), 0 < b.maxLabelDistance && (k = Math.max(0, y - q - b.maxLabelDistance),
                                ...
                                N = k, delete c.positionIndex, J = h.justify ? w[0] + (e ? -1 : 1) * (q + c.labelDistance) : b.getX(N < c.top + 2 || N > c.bottom - 2 ? k : N, e, c), C._attr = { visibility: O, align: g[6] }, C._pos = { x: J + h.x + ({ left: l, right: -l }[g[6]] || 0), y: N + h.y - 10 }, g.x = J, g.y = N, null === b.options.size && (D = C.getBBox().width, k = null, J - D < l ? (k = Math.round(D - J + l), v[3] = Math.max(k, v[3])) : J + D > n - l && (k = Math.round(J + D - n + l), v[1] = Math.max(k, v[1])), 0 > N - r / 2 ? v[0] = Math.max(Math.round(-N + r / 2), v[0]) : N + r / 2 > p && (v[2] = Math.max(Math.round(N + r / 2 - p), v[2])), C.sideOverflow = k)
                    }), 0 === A(v) || this.verifyDataLabelOverflow(v)) &&
                    (this.placeDataLabels(), k && F(this.points, function(a) { var c;
                        m = a.connector; if ((C = a.dataLabel) && C._pos && a.visible && 0 < a.labelDistance) { O = C._attr.visibility; if (c = !m) a.connector = m = f.renderer.path().addClass("highcharts-data-label-connector highcharts-color-" + a.colorIndex).add(b.dataLabelsGroup), m.attr({ "stroke-width": k, stroke: h.connectorColor || a.color || "#666666" });
                            m[c ? "attr" : "animate"]({ d: b.connectorPath(a.labelPos) });
                            m.attr("visibility", O) } else m && (a.connector = m.destroy()) }))
            }, m.pie.prototype.connectorPath =
            function(a) { var b = a.x,
                    c = a.y; return t(this.options.dataLabels.softConnector, !0) ? ["M", b + ("left" === a[6] ? 5 : -5), c, "C", b, c, 2 * a[2] - a[4], 2 * a[3] - a[5], a[2], a[3], "L", a[4], a[5]] : ["M", b + ("left" === a[6] ? 5 : -5), c, "L", a[2], a[3], "L", a[4], a[5]] }, m.pie.prototype.placeDataLabels = function() {
                F(this.points, function(a) {
                    var b = a.dataLabel;
                    b && a.visible && ((a = b._pos) ? (b.sideOverflow && (b._attr.width = b.getBBox().width - b.sideOverflow, b.css({ width: b._attr.width + "px", textOverflow: "ellipsis" }), b.shortened = !0), b.attr(b._attr), b[b.moved ?
        ...
        m.column && (m.column.prototype.alignDataLabel = function(a, e, c, f, h) {
            ...
            m && (f = l(m), 0 > f.y && (f.height += f.y, f.y = 0), m = f.y + f.height - k.yAxis.len, 0 < m && (f.height -= m), b && (f = { x: k.yAxis.len - f.y - f.height, y: k.xAxis.len - f.x - f.width, width: f.height, height: f.width }), n || (b ? (f.x += p ? 0 : f.width, f.width = 0) : (f.y +=
    ...
    (function(a) {
        ...
        D.prototype.callbacks.push(function(a) {
            function f() {
                ...
                A(a.series || [], function(a) {
                    ...
                    (h.enabled ||
                        a._hasPointLabels) && !h.allowOverlap && a.visible && A(l, function(e) { A(a.points, function(a) { a[e] && (a[e].labelrank = G(a.labelrank, a.shapeArgs && a.shapeArgs.height), f.push(a[e])) }) })
                });
        ...
        D.prototype.hideOverlappingLabels = function(a) {
            var f = a.length,
                h, l, n, t, e, d, m, C, b, x = function(a, b, d, e, f, h, l, m) { return !(f > a + d || f + l < a || h > b + e || h + m < b) };
            for (l = 0; l < f; l++)
            ...
            A(a, function(a) {
                var b, c;
                a && (c = a.newOpacity, a.oldOpacity !== c && a.placed && (c ? a.show(!0) : b = function() { a.hide() }, a.alignAttr.opacity = c, a[a.isOld ? "animate" :
    ...
    (function(a) {
        ...
        I = a.TrackerMixin = {
            drawTrackerPoint: function() {
                var a = this,
                    b = a.chart.pointer,
                    c = function(a) { var c = b.getPointFromEvent(a); if (void 0 !== c) c.onMouseOver(a) };
                h(a.points, function(a) {
                    a.graphic && (a.graphic.element.point =
                        a);
                    a.dataLabel && (a.dataLabel.div ? a.dataLabel.div.point = a : a.dataLabel.element.point = a)
                });
                a._hasTracking || (h(a.trackerGroups, function(d) { if (a[d]) { a[d].addClass("highcharts-tracker").on("mouseover", c).on("mouseout", function(a) { b.onTrackerMouseOut(a) }); if (t) a[d].on("touchstart", c);
            ...
            drawTrackerGraph: function() {
                var a = this,
                    ...
                    g = a.tracker,
                    r, u = function() { if (f.hoverSeries !== a) a.onMouseOver() },
                    w = "rgba(192,192,192," + (B ? .0001 : .002) + ")";
                if (e && !c)
                    for (r = e + 1; r--;) "M" === d[r] && d.splice(r + 1, 0, d[r + 1] - n, d[r + 2], "L"), (r && "M" === d[r] || r === e) && d.splice(r, 0, "L", d[r - 2] + n, d[r - 1]);
                g ? g.attr({ d: d }) : a.graph && (a.tracker = m.path(d).attr({ "stroke-linejoin": "round", visibility: a.visible ? "visible" : "hidden", stroke: w, fill: c ? w : "none", "stroke-width": a.graph.strokeWidth() + (c ? 0 : 2 * n), zIndex: 2 }).add(a.group), h([a.tracker, a.markerGroup],
                    function(a) { a.addClass("highcharts-tracker").on("mouseover", u).on("mouseout", function(a) { l.onTrackerMouseOut(a) });
        ...
        l(m.prototype, {
            setItemEvents: function(a, b, c) {
                ...
                (c ? b : a.legendGroup).on("mouseover", function() { a.setState("hover");
                    e.addClass(f);
                    b.css(d.options.itemHoverStyle) }).on("mouseout", function() { b.css(C(a.visible ? d.itemStyle : d.itemHiddenStyle));
                    e.removeClass(f);
                    a.setState() }).on("click", function(b) { var c = function() { a.setVisible && a.setVisible() };
                    b = { browserEvent: b };
                    a.firePointEvent ? a.firePointEvent("legendItemClick", b, c) : w(a, "legendItemClick", b, c) })
            },
            createCheckboxForItem: function(a) {
                a.checkbox = G("input", { type: "checkbox", checked: a.selected, defaultChecked: a.selected },
                    this.options.itemCheckboxStyle, this.chart.container);
                D(a.checkbox, "click", function(b) { w(a.series || a, "checkboxClick", { checked: b.target.checked, item: a }, function() { a.select() }) })
            }
        });
        ...
        l(A.prototype, {
            ...
            zoom: function(a) { var c, e = this.pointer,
                    f = !1,
                    k;!a || a.resetSelection ? h(this.axes, function(a) { c = a.zoom() }) : h(a.xAxis.concat(a.yAxis), function(a) { var b = a.axis;
        ...
        l(x.prototype, {
            ...
            onMouseOver: function(a) { var b = this.series.chart.pointer;
                this.firePointEvent("mouseOver");
                b.runPointActions(a, this) },
            onMouseOut: function() { var a = this.series.chart;
                this.firePointEvent("mouseOut");
                h(a.hoverPoints || [], function(a) { a.setState() });
                ...
                if (!(a === this.state && !c || this.selected && "select" !== a || !1 === k.enabled || a && (g || n && !1 === t.enabled) || a && u.states && u.states[a] && !1 === u.states[a].enabled)) {
                    ...
                    if (this.graphic) this.state && this.graphic.removeClass("highcharts-point-" + this.state), a && this.graphic.addClass("highcharts-point-" + a), this.graphic.attr(h.pointAttribs(this, a)), A && this.graphic.animate(A, b(w.options.chart.animation, t.animation, m.animation)), r && r.hide();
                        ...
                        if (a && t) {
                            ...
                            if (r) r[c ? "animate" : "attr"]({ x: A.x, y: A.y });
                    ...
                    }(d = k.halo) && d.size ? (x || (h.halo = x = w.renderer.path().add(E ? h.markerGroup : h.group)), x[c ? "animate" : "attr"]({ d: this.haloPath(d.size) }), x.attr({ "class": "highcharts-halo highcharts-color-" + b(this.colorIndex, h.colorIndex) }), x.point = this, x.attr(l({ fill: this.color || h.color, "fill-opacity": d.opacity, zIndex: -1 }, d.attributes))) : x && x.point && x.point.haloPath && x.animate({ d: x.point.haloPath(0) });
                    this.state =
                        a
                }
            },
        ...
        l(c.prototype, {
            ...
            setState: function(a) {
                var c = this,
                    ...
                    d = 0;
                a = a || "";
                if (c.state !== a && (h([c.group, c.markerGroup, c.dataLabelsGroup], function(b) { b && (c.state && b.removeClass("highcharts-series-" + c.state), a && b.addClass("highcharts-series-" + a)) }), c.state = a, !f[a] || !1 !== f[a].enabled) && (a && (k = f[a].lineWidth || k + (f[a].lineWidthPlus || 0)), e && !e.dashstyle))
            ...
            setVisible: function(a, b) {
                ...
                h(["group", "dataLabelsGroup", "markerGroup", "tracker", "tt"], function(a) { if (c[a]) c[a][f]() });
                if (d.hoverSeries === c || (d.hoverPoint && d.hoverPoint.series) === c) c.onMouseOut();
                e && d.legend.colorizeItem(c, a);
                c.isDirty = !0;
                c.options.stacking && h(d.series,
                    function(a) { a.options.stacking && a.visible && (a.isDirty = !0) });
                h(c.linkedSeries, function(b) { b.setVisible(a, !1) });
                k && (d.isDirtyBox = !0);
                !1 !== b && d.redraw();
                w(c, f)
            },
    ...
    (function(a) {
        ...
        D.prototype.setResponsive =
            function(f) { var h = this.options.responsive,
                    l = [],
                    e = this.currentResponsive;
                h && h.rules && A(h.rules, function(d) { void 0 === d._id && (d._id = a.uniqueKey());
                    this.matchResponsiveRule(d, l, f) }, this); var d = a.merge.apply(0, a.map(l, function(d) { return a.find(h.rules, function(a) { return a._id === d }).chartOptions })),
                    l = l.toString() || void 0;
                l !== (e && e.ruleIds) && (e && this.update(e.undoOptions, f), l ? (this.currentResponsive = { ruleIds: l, mergedOptions: d, undoOptions: this.currentOptions(d) }, this.update(d, f)) : this.currentResponsive = void 0) };
        D.prototype.matchResponsiveRule = function(a, h) { var l = a.condition;
            (l.callback || function() { return this.chartWidth <= f(l.maxWidth, Number.MAX_VALUE) && this.chartHeight <= f(l.maxHeight, Number.MAX_VALUE) && this.chartWidth >= f(l.minWidth, 0) && this.chartHeight >= f(l.minHeight, 0) }).call(this) && h.push(a._id) };
